...
class __TwigTemplate_05b9ece25dbb379ad1af3b75030ad13e97159f7f39645dd5fbc071842868828f extends Twig_Template
{
      ...
      <div class=\"course-list\">
        <div class=\"row\">
          ";
            ...
            $context['_seq'] = twig_ensure_traversable(($context["RecentLiveCourseSets"] ?? null));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["courseSet"]) {
              ...
              ";
                  ...
                  <div class=\"date\">
                    ";
                    // line 30
                    echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute(($context["task"] ?? null), "startTime", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("site.date_format")), "html", null, true);
                    echo "
                  </div>
                </div>
              ";
          ...
          ";
            // line 38
            $context["emptyCourseNum"] = (4 - twig_length_filter($this->env, ($context["RecentLiveCourseSets"] ?? null)));
            // line 39
            echo "          ";
            if ((($context["emptyCourseNum"] ?? null) > 0)) {
                // line 40
                echo "            ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(range(1, ($context["emptyCourseNum"] ?? null)));
...
";
    ...
    {
        return new Twig_Source("", "default/live-course.html.twig", "D:\\workspace\\vboxShare\\edusoho\\app\\Resources\\views\\default\\live-course.html.twig");
    }
}
