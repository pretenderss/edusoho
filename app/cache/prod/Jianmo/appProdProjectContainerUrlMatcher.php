...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/qrcode') && preg_match('#^/qrcode/(?P<text>[\\w\\W]+)/(?P<extension>jpg|png|gif)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'endroid_qrcode')), array (  '_controller' => 'Endroid\\QrCode\\Bundle\\Controller\\QrCodeController::generateAction',  '_permission' => '',  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/api')) {
            // api_entrypoint_start
            if (preg_match('#^/api/(?P<res1>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_1
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_1')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_2
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)/(?P<res2>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_2')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_3
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)/(?P<res2>[^/]++)/(?P<slug2>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_3')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_4
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)/(?P<res2>[^/]++)/(?P<slug2>[^/]++)/(?P<res3>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_4')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_5
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)/(?P<res2>[^/]++)/(?P<slug2>[^/]++)/(?P<res3>[^/]++)/(?P<slug3>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_5')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_6
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)/(?P<res2>[^/]++)/(?P<slug2>[^/]++)/(?P<res3>[^/]++)/(?P<slug3>[^/]++)/(?P<res4>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_6')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }

            // api_entrypoint_start_7
            if (preg_match('#^/api/(?P<res1>[^/]++)/(?P<slug1>[^/]++)/(?P<res2>[^/]++)/(?P<slug2>[^/]++)/(?P<res3>[^/]++)/(?P<slug3>[^/]++)/(?P<res4>[^/]++)/(?P<slug4>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'api_entrypoint_start_7')), array (  '_controller' => 'ApiBundle\\Controller\\EntryPointController::startAction',  '_permission' => '',  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/translations') && preg_match('#^/translations(?:/(?P<domain>[\\w]+)(?:\\.(?P<_format>js|json))?)?$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'bazinga_jstranslation_js')), array (  '_controller' => 'bazinga.jstranslation.controller:getTranslationsAction',  'domain' => 'messages',  '_format' => 'js',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/mapi_v2')) {
            ...
            if (0 === strpos($pathinfo, '/mapi_v2/order') && preg_match('#^/mapi_v2/order/(?P<id>[^/]++)/submit_pay_request$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'mapi_order_submit_pay_request')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\MobileOrderController::submitPayRequestAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/mapi_v2/pay') && preg_match('#^/mapi_v2/pay/(?P<name>[^/]++)/alipay_notify$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'topxia_mobile_alipay_notify')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\MobileAlipayController::payNotifyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/mapi_v2/pay')) {
                ...
                if (preg_match('#^/mapi_v2/pay/(?P<name>[^/]++)/alipay_merchant$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'topxia_mobile_alipay_merchant')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\MobileAlipayController::payMerchantAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // topxia_mobile_alipay_callback
                if (preg_match('#^/mapi_v2/pay/(?P<name>[^/]++)/alipay_callback$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'topxia_mobile_alipay_callback')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\MobileAlipayController::payCallBackAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/mapi_v2/mobile')) {
                ...
                if (preg_match('#^/mapi_v2/mobile/(?P<code>[^/]++)/resource$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'mapi_mobile_esmobile_app_resource')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\MobileAppController::resourceAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/mapi_v2/(?P<service>[^/]++)/(?P<method>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'mapi_mobile_api')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\MobileApiController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_mapi_mobile_api:
        ...
        // ltc
        if (0 === strpos($pathinfo, '/ltc') && preg_match('#^/ltc/(?P<endpoint>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ltc')), array (  '_controller' => 'AppBundle\\Controller\\LTC\\RuntimeController::entryPointAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/anon')) {
            ...
            if (0 === strpos($pathinfo, '/anon/translations') && preg_match('#^/anon/translations(?:/(?P<domain>[\\w]+)(?:\\.(?P<_format>js|json))?)?$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'jstranslation_js')), array (  '_controller' => 'bazinga.jstranslation.controller:getTranslationsAction',  'domain' => 'messages',  '_format' => 'js',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/log')) {
                ...
                if (0 === strpos($pathinfo, '/login')) {
                    ...
                    if (0 === strpos($pathinfo, '/login/face_token')) {
                        // login_face_token
                        if (preg_match('#^/login/face_token/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'login_face_token')), array (  '_controller' => 'AppBundle\\Controller\\LoginController::faceTokenAction',  '_permission' =>   array (  ),  '_h5' => false,));
                        }

                        // login_parse_face_token
                        if (0 === strpos($pathinfo, '/login/face_token/parse') && preg_match('#^/login/face_token/parse/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'login_parse_face_token')), array (  '_controller' => 'AppBundle\\Controller\\LoginController::parseFaceTokenAction',  '_permission' =>   array (  ),  '_h5' => false,));
                        }
                    ...
                    if (0 === strpos($pathinfo, '/login/bind')) {
                        ...
                        if (preg_match('#^/login/bind/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'login_bind')), array (  '_controller' => 'AppBundle\\Controller\\LoginBindController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
                        }

                        // login_bind_callback
                        if (preg_match('#^/login/bind/(?P<type>[^/]++)/callback$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'login_bind_callback')), array (  '_controller' => 'AppBundle\\Controller\\LoginBindController::callbackAction',  '_permission' =>   array (  ),  '_h5' => false,));
                        }
        ...
        if (0 === strpos($pathinfo, '/oauth2/login')) {
            ...
            if (0 === strpos($pathinfo, '/oauth2/login/bind_')) {
                // oauth2_login_bind_account
                if ($pathinfo === '/oauth2/login/bind_account') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                ...
                if ($pathinfo === '/oauth2/login/bind_login') {
            ...
            // oauth2_login_create
            if ($pathinfo === '/oauth2/login/create') {
            ...
            if ($pathinfo === '/oauth2/login/success') {
        ...
        if (0 === strpos($pathinfo, '/distributor_')) {
            ...
            if ($pathinfo === '/distributor_register') {
            ...
            // distributor_product
            if ($pathinfo === '/distributor_product') {
        ...
        if (0 === strpos($pathinfo, '/register')) {
            ...
            if (0 === strpos($pathinfo, '/register/su')) {
                ...
                if (0 === strpos($pathinfo, '/register/submited') && preg_match('#^/register/submited/(?P<id>[^/]++)/(?P<hash>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'register_submited')), array (  '_controller' => 'AppBundle\\Controller\\RegisterController::submitedAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/register/email')) {
                if (0 === strpos($pathinfo, '/register/email/reset')) {
                    ...
                    if (preg_match('#^/register/email/reset/(?P<id>[^/]++)/(?P<hash>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'register_reset_email')), array (  '_controller' => 'AppBundle\\Controller\\RegisterController::resetEmailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/register/email/send') && preg_match('#^/register/email/send/(?P<id>[^/]++)/(?P<hash>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'register_email_send')), array (  '_controller' => 'AppBundle\\Controller\\RegisterController::emailSendAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/register/email/verify') && preg_match('#^/register/email/verify/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'register_email_verify')), array (  '_controller' => 'AppBundle\\Controller\\RegisterController::emailVerifyAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/attachment')) {
            ...
            if (0 === strpos($pathinfo, '/attachments') && preg_match('#^/attachments/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_list')), array (  '_controller' => 'AppBundle:Attachment:list',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_attachment_list:
            ...
            if (preg_match('#^/attachment/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/formFields$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_form_fields')), array (  '_controller' => 'AppBundle:Attachment:formFields',  'targetId' => 0,  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/hls')) {
            // hls_playlist
            if (preg_match('#^/hls/(?P<id>[^/]++)/playlist/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_playlist')), array (  '_controller' => 'AppBundle\\Controller\\HLSVideoController::playlistAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // hls_audio_playlist
            if (preg_match('#^/hls/(?P<id>[^/]++)/audio/playlist/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_audio_playlist')), array (  '_controller' => 'AppBundle\\Controller\\HLSAudioController::playlistAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/player') && preg_match('#^/player/(?P<id>[^/]++)/file/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'player_local_media')), array (  '_controller' => 'AppBundle\\Controller\\PlayerController::localMediaAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/hls')) {
            // hls_stream
            if (preg_match('#^/hls/(?P<id>[^/]++)/stream/(?P<level>[^/]++)/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_stream')), array (  '_controller' => 'AppBundle\\Controller\\HLSVideoController::streamAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // hls_audio_stream
            if (preg_match('#^/hls/(?P<id>[^/]++)/audio/stream/(?P<level>[^/]++)/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_audio_stream')), array (  '_controller' => 'AppBundle\\Controller\\HLSAudioController::streamAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // hls_clef
            if (preg_match('#^/hls/(?P<id>[^/]++)/clef/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_clef')), array (  '_controller' => 'AppBundle\\Controller\\HLSVideoController::clefAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // hls_audio_clef
            if (preg_match('#^/hls/(?P<id>[^/]++)/audio/clef/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'hls_audio_clef')), array (  '_controller' => 'AppBundle\\Controller\\HLSAudioController::clefAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/live')) {
            ...
            if (0 === strpos($pathinfo, '/liveroom') && preg_match('#^/liveroom/(?P<roomId>[^/]++)/ticket$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'liveroom_ticket')), array (  '_controller' => 'AppBundle\\Controller\\LiveroomController::ticketAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/order')) {
            // order_detail
            if (preg_match('#^/order/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'order_detail')), array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // order_cancel_refund
            if (preg_match('#^/order/(?P<orderId>[^/]++)/cancel_refund$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_order_cancel_refund;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'order_cancel_refund')), array (  '_controller' => 'AppBundle\\Controller\\Order\\OrderRefundController::cancelRefundAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/media')) {
            ...
            if (preg_match('#^/media/(?P<mediaId>[^/]++)/play$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_play')), array (  '_controller' => 'AppBundle\\Controller\\Media\\IndexController::playAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // media_subtitle_preview
            if (preg_match('#^/media/(?P<mediaId>[^/]++)/subtitles/preview$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_subtitle_preview')), array (  '_controller' => 'AppBundle\\Controller\\SubtitleController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // media_subtitle_manage
            if (preg_match('#^/media/(?P<mediaId>[^/]++)/subtitles/manage$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_subtitle_manage')), array (  '_controller' => 'AppBundle\\Controller\\SubtitleController::manageAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // media_subtitle_list
            if (preg_match('#^/media/(?P<mediaId>[^/]++)/subtitles$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_subtitle_list')), array (  '_controller' => 'AppBundle\\Controller\\SubtitleController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/media/(?P<mediaId>[^/]++)/subtitle/create$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_subtitle_create')), array (  '_controller' => 'AppBundle\\Controller\\SubtitleController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/media/(?P<mediaId>[^/]++)/subtitle/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_subtitle_delete')), array (  '_controller' => 'AppBundle\\Controller\\SubtitleController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/announcement')) {
            ...
            if (preg_match('#^/announcement/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_list')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // announcement_show_all
            if (preg_match('#^/announcement/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/all$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_show_all')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::showAllAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // announcement_add
            if (0 === strpos($pathinfo, '/announcement/manage') && preg_match('#^/announcement/manage/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_add')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // announcement_show
            if (preg_match('#^/announcement/(?P<id>[^/]++)/(?P<targetId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_show')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // announcement_manage
            if (preg_match('#^/announcement/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/manage$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_manage')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::manageAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // announcement_update
            if (preg_match('#^/announcement/(?P<id>[^/]++)/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/update$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_update')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/announcement/(?P<id>[^/]++)/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_delete')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/settings')) {
            ...
            if ($pathinfo === '/settings/profile/avatar/crop/modal') {
            ...
            if (0 === strpos($pathinfo, '/settings/unbind') && preg_match('#^/settings/unbind/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'settings_binds_unbind')), array (  '_controller' => 'AppBundle\\Controller\\SettingsController::unBindAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/settings/bind')) {
                ...
                if (preg_match('#^/settings/bind/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'settings_binds_bind')), array (  '_controller' => 'AppBundle\\Controller\\SettingsController::bindAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // settings_binds_bind_callback
                if (preg_match('#^/settings/bind/(?P<type>[^/]++)/callback$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'settings_binds_bind_callback')), array (  '_controller' => 'AppBundle\\Controller\\SettingsController::bindCallbackAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/tag')) {
            ...
            if (preg_match('#^/tag/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tag_show')), array (  '_controller' => 'AppBundle\\Controller\\TagController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/notification')) {
            ...
            if (preg_match('#^/notification/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'batch_notification_show')), array (  '_controller' => 'AppBundle\\Controller\\NotificationController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/my')) {
            if (0 === strpos($pathinfo, '/my/teaching')) {
                ...
                if (0 === strpos($pathinfo, '/my/teaching/course_sets') && preg_match('#^/my/teaching/course_sets(?:/(?P<filter>[^/]++))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_teaching_course_sets')), array (  '_controller' => 'AppBundle\\Controller\\My\\CourseSetController::teachingAction',  'filter' => 'normal',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/my/teaching/open/courses') && preg_match('#^/my/teaching/open/courses(?:/(?P<filter>[^/]++))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_teaching_open_courses')), array (  '_controller' => 'AppBundle\\Controller\\My\\OpenCourseController::teachingAction',  'filter' => 'open',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // my_teaching_threads
                if (0 === strpos($pathinfo, '/my/teaching/threads') && preg_match('#^/my/teaching/threads/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_teaching_threads')), array (  '_controller' => 'AppBundle\\Controller\\My\\ThreadController::teachingAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if ($pathinfo === '/my/teaching/live/calendar') {
            ...
            if (0 === strpos($pathinfo, '/my/testpaper')) {
                ...
                if (0 === strpos($pathinfo, '/my/testpaper/check') && preg_match('#^/my/testpaper/check(?:/(?P<status>[^/]++))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_testpaper_check_list')), array (  '_controller' => 'AppBundle\\Controller\\My\\TestpaperController::checkListAction',  'status' => 'reviewing',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/my/question')) {
                ...
                if (preg_match('#^/my/question/(?P<id>[^/]++)/favorite/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_favorite_question_preview')), array (  '_controller' => 'AppBundle\\Controller\\My\\QuestionController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // my_question_favorite
                if (preg_match('#^/my/question/(?P<questionId>[^/]++)/favorite$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_question_favorite')), array (  '_controller' => 'AppBundle\\Controller\\My\\QuestionController::favoriteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/my/question/unfavorite') && preg_match('#^/my/question/unfavorite/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_question_unfavorite')), array (  '_controller' => 'AppBundle\\Controller\\My\\QuestionController::unFavoriteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/my/homework')) {
                ...
                if (0 === strpos($pathinfo, '/my/homework/check') && preg_match('#^/my/homework/check(?:/(?P<status>[^/]++))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_homework_check_list')), array (  '_controller' => 'AppBundle\\Controller\\My\\HomeworkController::checkListAction',  'status' => 'reviewing',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // my_homework_list
                if (preg_match('#^/my/homework/(?P<status>[^/]++)/list$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_homework_list')), array (  '_controller' => 'AppBundle\\Controller\\My\\HomeworkController::listAction',  'status' => 'finished',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/my/order')) {
                ...
                if (0 === strpos($pathinfo, '/my/order_refund')) {
                    ...
                    if (preg_match('#^/my/order_refund/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_order_refund_detail')), array (  '_controller' => 'AppBundle\\Controller\\My\\OrderRefundController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                    // my_order_refund_apply
                    if (preg_match('#^/my/order_refund/(?P<id>[^/]++)/apply$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_order_refund_apply')), array (  '_controller' => 'AppBundle\\Controller\\My\\OrderRefundController::applyRefundAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/my/order/(?P<id>[^/]++)/cancel$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_order_cancel')), array (  '_controller' => 'AppBundle\\Controller\\My\\OrderController::cancelAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_my_order_cancel:

                // web_user_order_detail
                if (preg_match('#^/my/order/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'web_user_order_detail')), array (  '_controller' => 'AppBundle\\Controller\\My\\OrderController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_show')), array (  '_controller' => 'AppBundle\\Controller\\UserController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)/saveinfo$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_info_fill')), array (  '_controller' => 'AppBundle\\Controller\\UserController::fillInfoWhenBuyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_user_info_fill:
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)/about$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_about')), array (  '_controller' => 'AppBundle\\Controller\\UserController::aboutAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_teach
            if (preg_match('#^/user/(?P<id>[^/]++)/teach$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_teach')), array (  '_controller' => 'AppBundle\\Controller\\UserController::teachAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_learn
            if (preg_match('#^/user/(?P<id>[^/]++)/learn$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_learn')), array (  '_controller' => 'AppBundle\\Controller\\UserController::learnAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_favorited
            if (preg_match('#^/user/(?P<id>[^/]++)/favorited$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_favorited')), array (  '_controller' => 'AppBundle\\Controller\\UserController::favoritedAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_group
            if (preg_match('#^/user/(?P<id>[^/]++)/group$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_group')), array (  '_controller' => 'AppBundle\\Controller\\UserController::groupAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_following
            if (preg_match('#^/user/(?P<id>[^/]++)/following$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_following')), array (  '_controller' => 'AppBundle\\Controller\\UserController::followingAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_follower
            if (preg_match('#^/user/(?P<id>[^/]++)/follower$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_follower')), array (  '_controller' => 'AppBundle\\Controller\\UserController::followerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)/follow$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_follow')), array (  '_controller' => 'AppBundle\\Controller\\UserController::followAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_user_follow:
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)/unfollow$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_unfollow')), array (  '_controller' => 'AppBundle\\Controller\\UserController::unfollowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_user_unfollow:
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)/teaching/classrooms$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_teaching_classrooms')), array (  '_controller' => 'AppBundle\\Controller\\UserController::teachingAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_learning_classrooms
            if (preg_match('#^/user/(?P<id>[^/]++)/learning/classrooms$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_learning_classrooms')), array (  '_controller' => 'AppBundle\\Controller\\UserController::learningAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // user_card_show
            if (preg_match('#^/user/(?P<userId>[^/]++)/card/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_card_show')), array (  '_controller' => 'AppBundle\\Controller\\UserController::cardShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/message')) {
            ...
            if (0 === strpos($pathinfo, '/message/create') && preg_match('#^/message/create/(?P<toId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'message_create')), array (  '_controller' => 'AppBundle\\Controller\\MessageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/message/send')) {
                ...
                if (preg_match('#^/message/send/(?P<receiverId>[^/]++)/to/receiver/?$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'message_send_to_receiver')), array (  '_controller' => 'AppBundle\\Controller\\MessageController::sendToAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/message/conversation')) {
                ...
                if (preg_match('#^/message/conversation/(?P<conversationId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'message_conversation_show')), array (  '_controller' => 'AppBundle\\Controller\\MessageController::showConversationAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/message/conversation/(?P<conversationId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'message_conversation_delete')), array (  '_controller' => 'AppBundle\\Controller\\MessageController::deleteConversationAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/message/conversation/(?P<conversationId>[^/]++)/message/(?P<messageId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'message_delete')), array (  '_controller' => 'AppBundle\\Controller\\MessageController::deleteConversationMessageAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_message_delete:
        ...
        if (0 === strpos($pathinfo, '/carticle')) {
            ...
            if (preg_match('#^/carticle/(?P<alias>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'content_article_show')), array (  '_controller' => 'AppBundle\\Controller\\ContentController::articleShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/activity')) {
            ...
            if (preg_match('#^/activity/(?P<alias>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'content_activity_show')), array (  '_controller' => 'AppBundle\\Controller\\ContentController::activityShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/page')) {
            ...
            if (preg_match('#^/page/(?P<alias>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'content_page_show')), array (  '_controller' => 'AppBundle\\Controller\\ContentController::pageShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (0 === strpos($pathinfo, '/course_set') && preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/live_capacity$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_live_capacity')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::liveCapacityAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/article')) {
            ...
            if (preg_match('#^/article/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_detail')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // article_category
            if (0 === strpos($pathinfo, '/article/category') && preg_match('#^/article/category/(?P<categoryCode>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_category')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::categoryAction',  'category' => '',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/article/(?P<id>[^/]++)/post$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_post')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::postAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_article_post:
            ...
            if (preg_match('#^/article/(?P<articleId>[^/]++)/post/(?P<postId>[^/]++)/$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_post_reply')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::postReplyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/article/(?P<articleId>[^/]++)/like$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_like')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::likeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_article_like:
            ...
            if (preg_match('#^/article/(?P<articleId>[^/]++)/canceLike$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_cancel_like')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::cancelLikeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_article_cancel_like:

            // article_post_jump
            if (preg_match('#^/article/(?P<articleId>[^/]++)/post/(?P<postId>[^/]++)/jump$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_post_jump')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::postJumpAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // article_tag_show
            if (0 === strpos($pathinfo, '/article/tag') && preg_match('#^/article/tag/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_tag_show')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::tagAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/group')) {
            ...
            if (preg_match('#^/group/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_show')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::groupIndexAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/group/(?P<id>[^/]++)/join$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_join')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::groupJoinAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_group_join:
            ...
            if (preg_match('#^/group/(?P<id>[^/]++)/exit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_exit')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::groupExitAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_group_exit:
            ...
            if (0 === strpos($pathinfo, '/group/member')) {
                ...
                if (preg_match('#^/group/member/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_member')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::groupMemberAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/group/member/delete') && preg_match('#^/group/member/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_member_delete')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::deleteMembersAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/group/set/admin') && preg_match('#^/group/set/admin/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_set_admin')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::setAdminAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_remove_admin
            if (0 === strpos($pathinfo, '/group/remove/admin') && preg_match('#^/group/remove/admin/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_remove_admin')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::removeAdminAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_set
            if (preg_match('#^/group/(?P<id>[^/]++)/setting/info$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_set')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::groupSetAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_setLogoCrop
            if (preg_match('#^/group/(?P<id>[^/]++)/setting/logoCrop$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_setLogoCrop')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::logoCropAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_logo_set
            if (preg_match('#^/group/(?P<id>[^/]++)/setting/logo$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_logo_set')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::setGrouplogoAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_edit
            if (0 === strpos($pathinfo, '/group/info/edit') && preg_match('#^/group/info/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_edit')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::groupEditAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/group/set/backgroundlogo') && preg_match('#^/group/set/backgroundlogo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_backgroundlogo_set')), array (  '_controller' => 'AppBundle\\Controller\\GroupController::setGroupBackgroundLogoAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_search
            if (preg_match('#^/group/(?P<id>[^/]++)/serach$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_search')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::searchResultAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_thread_post
            if (0 === strpos($pathinfo, '/group/thread') && preg_match('#^/group/thread/(?P<groupId>[^/]++)/(?P<threadId>[^/]++)/post$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_post')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::postThreadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_thread_add
            if (preg_match('#^/group/(?P<id>[^/]++)/thread/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_add')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::addThreadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // group_thread_update
            if (preg_match('#^/group/(?P<id>[^/]++)/thread/(?P<threadId>[^/]++)/update$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_update')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::updateThreadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/group')) {
            ...
            if (preg_match('#^/group/(?P<id>[^/]++)/thread/(?P<threadId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_show')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::groupThreadIndexAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/group/thread')) {
                ...
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/collect$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_collect')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::collectAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/uncollect$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_uncollect')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::uncollectAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_group_thread_uncollect:

                // group_thread_setElite
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/setElite$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_setElite')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::setEliteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // group_thread_removeElite
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/removeElite$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_removeElite')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::removeEliteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // group_thread_setStick
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/setStick$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_setStick')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::setStickAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // group_thread_removeStick
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/removeStick$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_removeStick')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::removeStickAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // group_thread_closeThread
                if (preg_match('#^/group/thread/(?P<threadId>[^/]++)/closeThread/(?P<memberId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_closeThread')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::closeThreadAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/group/thread/deletePost') && preg_match('#^/group/thread/deletePost/(?P<postId>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_deletePost')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::deletePostAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/group/post') && preg_match('#^/group/post/(?P<postId>[^/]++)/reply$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_post_reply')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::postReplyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

        }

        // group_thread_adopt
        if (0 === strpos($pathinfo, '/thread') && preg_match('#^/thread/(?P<postId>[^/]++)/adopt$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'group_thread_adopt')), array (  '_controller' => 'AppBundle\\Controller\\GroupThreadController::adoptAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/note')) {
            ...
            if (preg_match('#^/note/(?P<id>[^/]++)/like$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'note_like')), array (  '_controller' => 'AppBundle\\Controller\\NoteController::likeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_note_like:
            ...
            if (preg_match('#^/note/(?P<id>[^/]++)/cancel_like$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'note_cancel_like')), array (  '_controller' => 'AppBundle\\Controller\\NoteController::cancelLikeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/pay/center/wxpay')) {
            ...
            if (0 === strpos($pathinfo, '/pay/center/wxpay_')) {
                // cashier_wechat_js_pay_h5
                if ($pathinfo === '/pay/center/wxpay_h5') {
                ...
                if ($pathinfo === '/pay/center/wxpay_mweb_app_trade') {
        ...
        if (0 === strpos($pathinfo, '/ca')) {
            if (0 === strpos($pathinfo, '/cashier')) {
                ...
                if ($pathinfo === '/cashier/password/check') {
                ...
                // cashier_pay_price
                if (preg_match('#^/cashier/(?P<sn>[^/]++)/price$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_cashier_pay_price;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_price')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CashierController::priceAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_cashier_pay_price:

                // cashier_pay_success
                if ($pathinfo === '/cashier/pay/success') {
            ...
            if (0 === strpos($pathinfo, '/callback')) {
                // cashier_pay_notify
                if (preg_match('#^/callback/(?P<payment>[^/]++)/notify$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_cashier_pay_notify;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_notify')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::notifyAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_cashier_pay_notify:

                // cashier_pay_return_for_app
                if (preg_match('#^/callback/(?P<payment>[^/]++)/return_for_app$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_return_for_app')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::returnForAppAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/h5cashier')) {
            // cashier_redirect_for_h5
            if ($pathinfo === '/h5cashier/redirect') {
            ...
            if ($pathinfo === '/h5cashier/pay/success') {
        ...
        if (0 === strpos($pathinfo, '/callback')) {
            ...
            if (preg_match('#^/callback/(?P<payment>[^/]++)/return_for_h5$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_return_for_h5')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::returnForH5Action',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // cashier_pay_return
            if (preg_match('#^/callback/(?P<payment>[^/]++)/return$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cashier_pay_return')), array (  '_controller' => 'AppBundle\\Controller\\Cashier\\CallbackController::returnAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/pay/center')) {
                ...
                if (0 === strpos($pathinfo, '/pay/center/pay')) {
                    ...
                    if (preg_match('#^/pay/center/pay/(?P<name>[^/]++)/return$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'pay_return')), array (  '_controller' => 'AppBundle:PayCenter:payReturn',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                    // pay_return_for_app
                    if (preg_match('#^/pay/center/pay/(?P<name>[^/]++)/return_for_app$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'pay_return_for_app')), array (  '_controller' => 'AppBundle:PayCenter:payReturnForApp',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                    // pay_notify
                    if (preg_match('#^/pay/center/pay/(?P<name>[^/]++)/notify$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'pay_notify')), array (  '_controller' => 'AppBundle:PayCenter:payNotify',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
        ...
        if (0 === strpos($pathinfo, '/thread')) {
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/jump$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_jump')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::jumpAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // thread_post_jump
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/jump$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post_jump')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::postJumpAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // thread_post
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::postAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post_reply')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::postReplyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_thread_post_reply:

            // thread_post_subposts
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/subposts$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post_subposts')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::subpostsAction',  'threadId' => 0,  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/article') && preg_match('#^/article/(?P<targetId>[^/]++)/post/(?P<postId>[^/]++)/subposts$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_post_subposts')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::subpostsAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/thread')) {
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post_delete')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::postDeleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/up$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post_up')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::postUpAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_thread_post_up:
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_delete')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_thread_delete:
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/set_sticky$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_set_sticky')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::setStickyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/cancel_sticky$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_cancel_sticky')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::cancelStickyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/set_nice$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_set_nice')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::setNiceAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_thread_set_nice:
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/cancel_nice$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_cancel_nice')), array (  '_controller' => 'AppBundle\\Controller\\ThreadController::cancelNiceAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_thread_cancel_nice:

            // thread_export_members
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/export/members$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_export_members')), array (  '_controller' => 'AppBundle\\Controller\\Thread\\MemberController::exportAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/ajax/thread') && preg_match('#^/ajax/thread/(?P<threadId>[^/]++)/members$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ajax_thread_member_show')), array (  '_controller' => 'AppBundle\\Controller\\Thread\\MemberController::ajaxFindMembersAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
            ...
            if (0 === strpos($pathinfo, '/edu_cloud/sms')) {
                if (0 === strpos($pathinfo, '/edu_cloud/sms_')) {
                    if (0 === strpos($pathinfo, '/edu_cloud/sms_send')) {
                        ...
                        if ($pathinfo === '/edu_cloud/sms_send_registration') {
                            if ($this->context->getMethod() != 'POST') {
                                $allow[] = 'POST';
                    ...
                    if (0 === strpos($pathinfo, '/edu_cloud/sms_check') && preg_match('#^/edu_cloud/sms_check/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'edu_cloud_sms_check')), array (  '_controller' => 'AppBundle\\Controller\\EduCloudController::smsCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/edu_cloud/sms/callback') && preg_match('#^/edu_cloud/sms/callback/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'edu_cloud_sms_send_callback')), array (  '_controller' => 'AppBundle\\Controller\\EduCloudController::smsCallBackAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if ($pathinfo === '/password/reset/email/success') {
        ...
        if ($pathinfo === '/settings/find_pay_password_by_question') {
        ...
        if (0 === strpos($pathinfo, '/qrcode/parse') && preg_match('#^/qrcode/parse/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'common_parse_qrcode')), array (  '_controller' => 'AppBundle\\Controller\\CommonController::parseQrcodeAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/esbar/my')) {
            ...
            if (0 === strpos($pathinfo, '/esbar/my/practice') && preg_match('#^/esbar/my/practice/(?P<status>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'esbar_my_practice')), array (  '_controller' => 'AppBundle\\Controller\\EsBar\\EsBarController::practiceAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/open/course')) {
            ...
            if ($pathinfo === '/open/course/explore') {
                return array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::exploreAction',  '_route' => 'open_course_explore',  '_permission' =>   array (  ),  '_h5' => false,);
            }

            // open_course_manage
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_publish
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/publish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_publish')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_base
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/base$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_base')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::baseAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_lesson
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/lesson$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::lessonAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_lesson_create
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/lesson/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_create')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_lesson_edit
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_edit')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::editAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/publish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_publish')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_lesson_delete
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_delete')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/unpublish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_unpublish')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::unpublishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/lesson/sort$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_sort')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::sortAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/picture/crop$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_picture_crop')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::pictureCropAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_teachers
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/teachers$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_teachers')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::teachersAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_teachers_match
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/teachers/match$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_teachers_match')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::teachersMatchAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_live_time_set
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/live/time$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_live_time_set')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::liveOpenTimeSetAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_marketing
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/marketing$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_marketing')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::marketingAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_students
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/students$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_students')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::studentsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_students_show
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/students/(?P<userId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_students_show')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::studentDetailAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_files
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/files$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_files')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseFileManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_file_show
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/file/(?P<fileId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_file_show')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseFileManageController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/file/(?P<fileId>[^/]++)/convert$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_file_convert')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseFileManageController::convertAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/show/delete/materials$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_delete_materials_show')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseFileManageController::deleteMaterialShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/materials/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_files_delete')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseFileManageController::deleteCourseFilesAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/recommend/pick(?:/(?P<filter>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_course_pick')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::pickAction',  'filter' => 'openCourse',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/recommend/(?P<recommendId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_recommend_course_delete')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::deleteRecommendCourseAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/replays/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_lesson_replays_edit')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::editLessonReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/replay/(?P<replayId>[^/]++)/update$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_replay_title_update')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::updateReplayTitleAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/student/export$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_student_export_csv')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::studentsExportAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_student_export_datas
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/student/export/datas$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_student_export_datas')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::studentsExportDatasAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_material
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/material$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_material')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::materialModalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/material/upload$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_material_upload')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::materialUploadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/material/(?P<materialId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_material_delete')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::materialDeleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/material/(?P<materialId>[^/]++)/download$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_material_download')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::materialDownloadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_manage_material_browser
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/material/browser$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_manage_material_browser')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseLessonManageController::materialBrowserAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_course_search
            if (preg_match('#^/open/course/(?P<id>[^/]++)/recommended/search/(?P<filter>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_course_search')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::searchAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_recommended_course_select
            if (preg_match('#^/open/course/(?P<id>[^/]++)/recommended/select$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_recommended_course_select')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::recommendedCoursesSelectAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_show
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_show')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::showAction',  'lessonId' => NULL,  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_lesson_learn
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/learn$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_lesson_learn')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::showAction',  'lessonId' => NULL,  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_lesson_show
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_lesson_show')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::lessonShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/favorite$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_favorite')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::favoriteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/unfavorite$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_unfavorite')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::unfavoriteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/like$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_like')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::likeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/unlike$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_unlike')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::unlikeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_open_course_unlike:

            // open_course_post
            if (preg_match('#^/open/course/(?P<id>[^/]++)/post$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_post')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::postAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/post/(?P<postId>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_post_reply')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::postReplyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/live_entry$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_course_play')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::entryAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // live_open_course_manage_replay
            if (preg_match('#^/open/course/(?P<id>[^/]++)/manage/replay$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_course_manage_replay')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::replayManageAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/live/replay/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_course_lesson_replay_create')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::createLessonReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/replay/upload$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_course_lesson_replay_upload')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::uploadModalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/live/replay/(?P<replayId>[^/]++)/entry$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_course_live_replay_entry')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::entryReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/live/replay/(?P<replayId>[^/]++)/url$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_course_live_replay_url')), array (  '_controller' => 'AppBundle\\Controller\\LiveOpenCourseController::getReplayUrlAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // live_open_lesson_time_check
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/manage/live/time/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_open_lesson_time_check')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseManageController::lessonTimeCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/es_live') && preg_match('#^/es_live/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)/lesson/(?P<lessonId>[^/]++)/replay/(?P<replayId>[^/]++)/show$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'es_live_room_replay_show')), array (  '_controller' => 'AppBundle\\Controller\\LiveroomController::playESLiveReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/open/course')) {
            // open_course_member_sms
            if (preg_match('#^/open/course/(?P<id>[^/]++)/member/sms$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_member_sms')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::memberSmsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_member_create
            if (preg_match('#^/open/course/(?P<id>[^/]++)/member/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_member_create')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::createMemberAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_lesson_player
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/player$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_lesson_player')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::playerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // open_course_mobile_check
            if (preg_match('#^/open/course/(?P<courseId>[^/]++)/mobile/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_mobile_check')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::mobileCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/open/course/(?P<id>[^/]++)/ad\\-modal/recommend/course$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'open_course_ad_modal_recommend_course')), array (  '_controller' => 'AppBundle\\Controller\\OpenCourseController::adModalRecommendCourseAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/importer')) {
            ...
            if (preg_match('#^/importer/(?P<type>[^/]++)/check$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'importer_check')), array (  '_controller' => 'AppBundle\\Controller\\ImporterController::checkAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_importer_check:
            ...
            if (preg_match('#^/importer/(?P<type>[^/]++)/import$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'importer_import')), array (  '_controller' => 'AppBundle\\Controller\\ImporterController::importAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_importer_import:

            // importer_index
            if (preg_match('#^/importer/(?P<type>[^/]++)/index$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'importer_index')), array (  '_controller' => 'AppBundle\\Controller\\ImporterController::templateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/trigger$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_activity_trigger')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\ActivityController::triggerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_activity_trigger:

            // course_acitvity_watch
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<id>[^/]++)/watch$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_acitvity_watch')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\VideoController::watchAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_activity_download
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activiy/(?P<activityId>[^/]++)/download$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_activity_download')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\DownloadController::downloadFileAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_activity_manage_custom_route
            if (preg_match('#^/course/(?P<fromCourseId>[^/]++)/manage/activity_(?P<mediaType>[^/]++)/(?P<id>[^/]++)/(?P<routeName>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_manage_activity_manage_custom_route;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_activity_manage_custom_route')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\ActivityController::customManageRouteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_activity_manage_custom_route:

            // course_manage_activity_content_modal
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/activity_(?P<type>[^/]++)/(?P<activityId>[^/]++)/content_modal$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_activity_content_modal')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\ActivityController::contentModalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_activity_finish_modal
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/activity_(?P<type>[^/]++)/(?P<activityId>[^/]++)/finish_modal$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_activity_finish_modal')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\ActivityController::finishModalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_activity_learning_custom_route
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/learning$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_activity_learning_custom_route')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\ActivityController::customLearningRouteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_show
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_show')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_preview
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/preview$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_preview')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_content_preview
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/content/preview$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_content_preview')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::contentPreviewAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_activity_show
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/activity_show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_activity_show')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::taskActivityAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_trigger
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/trigger$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_trigger')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::triggerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_finish
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/finish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_finish')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::finishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_qrcode
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/qrcode$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_qrcode')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::qrcodeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_finished_prompt
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/finished_prompt$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_finished_prompt')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::taskFinishedPromptAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/pre_create_check$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_pre_create_check')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::preCreateCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_task_pre_create_check:

            // course_manage_task_pre_update_check
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/pre_update_check$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_manage_task_pre_update_check;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_pre_update_check')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::preUpdateCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_task_pre_update_check:

            // course_manage_task_create
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_create')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_batch_create
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/batch/modal$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_batch_create')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::batchCreateTasksAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_publish
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/publish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_publish')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_unpublish
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/unpublish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_unpublish')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::unPublishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_fields
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task_fields/(?P<mode>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_fields')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::taskFieldsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_update
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_update')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_delete
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_delete')), array (  '_controller' => 'AppBundle\\Controller\\TaskManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_task_replay_edit
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/replay/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_replay_edit')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::editTaskReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/replay/(?P<replayId>[^/]++)/update_title$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_replay_title_update')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::updateTaskReplayTitleAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/replay/upload$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_replay_upload')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::uploadReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/replay/create$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_replay_create')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::createReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_task_replay_create:

            // course_manage_task_learn_detail
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/learn/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_task_learn_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::learnDataDetailAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_student_learn_detail_modal
            if (preg_match('#^/course/(?P<courseId>[^/]++)/student/(?P<userId>[^/]++)/learn/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_student_learn_detail_modal')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::studentDataDetailModalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // task_live_entry
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/live_entry$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'task_live_entry')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\LiveController::liveEntryAction',  '_permission' =>   array (  ),  '_h5' => true,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/replay/(?P<replayId>[^/]++)/entry$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_activity_replay_entry')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\LiveController::replayEntryAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // live_activity_replay_url
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/replay/(?P<replayId>[^/]++)/play$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'live_activity_replay_url')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\LiveController::replayUrlAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // task_live_replay_player
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/replay$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'task_live_replay_player')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\LiveController::liveReplayAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // task_live_trigger
            if (preg_match('#^/course/(?P<courseId>[^/]++)/activity/(?P<activityId>[^/]++)/live_trigger$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'task_live_trigger')), array (  '_controller' => 'AppBundle\\Controller\\Activity\\LiveController::triggerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_note_save
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/note/save$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_note_save')), array (  '_controller' => 'AppBundle\\Controller\\NoteController::saveCourseNoteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_show_plugins
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/show/plugins$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_show_plugins')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::taskPluginsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_show_plugin_task_list
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/plugin/task_list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_show_plugin_task_list')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::taskListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_show_plugin_task_list_by_paging
            if (preg_match('#^/course/(?P<courseId>[^/]++)/plugin/task_list/paging$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_show_plugin_task_list_by_paging')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::taskListByPagingAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_plugin_note
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/plugin/note$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_plugin_note')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::noteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_task_plugin_threads
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/plugin/threads$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_plugin_threads')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::threadsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/plugin/thread/create$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_plugin_thread_create')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::createThreadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/plugin/thread/(?P<threadId>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_plugin_thread_show')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::threadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/plugin/thread/(?P<threadId>[^/]++)/answer$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_plugin_thread_answer')), array (  '_controller' => 'AppBundle\\Controller\\TaskPluginController::answerQuestionAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_task_plugin_thread_answer:

            // course_manage_chapter_manage
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/chapter/manage$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_chapter_manage')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ChapterManageController::manageAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/chapter/(?P<chapterId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_chapter_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ChapterManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_chapter_delete:

            // course_manage_lesson_create
            if (preg_match('#^/course/(?P<courseId>[^/]++)/lesson/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_create')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_lesson_batch_create
            if (preg_match('#^/course/(?P<courseId>[^/]++)/lesson/batch_create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_batch_create')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::batchCreateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_lesson_valid_num
            if (preg_match('#^/course/(?P<courseId>[^/]++)/lesson/valid_num$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_manage_lesson_valid_num;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_valid_num')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::validLessonNumAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_lesson_valid_num:

            // course_manage_lesson_update
            if (preg_match('#^/course/(?P<courseId>[^/]++)/lesson/(?P<lessonId>[^/]++)/update$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_update')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_lesson_publish
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/publish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_publish')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_lesson_unpublish
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/unpublish$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_unpublish')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::unpublishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_lesson_delete
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_lesson_set_optional
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/setoptional$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_manage_lesson_set_optional;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_set_optional')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::setOptionalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_lesson_set_optional:

            // course_manage_lesson_unset_optional
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/lesson/(?P<lessonId>[^/]++)/unsetoptional$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_manage_lesson_unset_optional;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_lesson_unset_optional')), array (  '_controller' => 'AppBundle\\Controller\\Course\\LessonManageController::unsetOptionalAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_manage_lesson_unset_optional:

            // course_manage_change_lesson_show_status
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/change/lesson/show/status$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_manage_change_lesson_show_status;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_change_lesson_show_status')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::hidePublishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/course/explore') && preg_match('#^/course/explore(?:/(?P<category>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_explore')), array (  '_controller' => 'AppBundle\\Controller\\ExploreController::courseSetsAction',  'category' => '',  '_permission' =>   array (  ),  '_h5' => true,));
            }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/sync$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_sync')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::syncInfoAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_unlock
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/unlock$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_unlock')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::unlockAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_unlock_confirm
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/unlock_confirm$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_unlock_confirm')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::unlockConfirmAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_courses
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/courses$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_courses')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_create
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/create$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_create')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_copy
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/copy$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_copy')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::copyAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_info
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/info$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_info')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::infoAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_overview
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/overview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_overview')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::overviewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

            }

            // course_set_manage_task_detail
            if (preg_match('#^/course/(?P<courseId>[^/]++)/task/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_task_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::taskDetailListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_set_manage_student_detail
            if (preg_match('#^/course/(?P<courseId>[^/]++)/student/detail$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_student_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskLearnDataController::studentDetailAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            if (0 === strpos($pathinfo, '/course_set')) {
                // course_set_manage_course_trendency
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/trendency$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_trendency')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::trendencyAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_tasks
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/tasks$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_tasks')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::tasksAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_replay
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/replay$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_replay')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::replayAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/marketing$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_marketing')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::marketingAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/teachers$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_teachers')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::teachersAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/teachers_match$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_teachers_match')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::teachersMatchAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::studentsAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_records
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/(?P<type>[^/]++)/records$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_records')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::studentRecordsAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students/add$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_add')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::createCourseStudentAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students/(?P<userId>[^/]++)/remove$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_remove')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::removeCourseStudentAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/student/(?P<userId>[^/]++)/remark$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_remark')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::remarkAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_students_deadline_batch
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/student/deadline$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_deadline_batch')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::batchUpdateMemberDeadlinesAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_students_deadline_batch_day_check
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/student/day/check$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_deadline_batch_day_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::checkDayAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_students_deadline_batch_deadline_check
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/student/deadline/check$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_deadline_batch_deadline_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::checkDeadlineAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students/(?P<userId>[^/]++)/process$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_process')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::studyProcessAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students/check$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::checkStudentAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students/(?P<userId>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/students/(?P<userId>[^/]++)/defined_show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_students_defined_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\StudentManageController::definedShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_course_orders
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/orders$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_orders')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::ordersAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/questionmarker$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_question_marker')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::questionMarkerStatsAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/course/(?P<courseId>[^/]++)/questionmarker/(?P<questionMarkerId>[^/]++)/analysis$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_question_marker_analysis')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::questionMarkerAnalysisAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/course/(?P<courseId>[^/]++)/close_check$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_close_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::closeCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/course/(?P<courseId>[^/]++)/close$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_close')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::closeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/course/(?P<courseId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/course/(?P<courseId>[^/]++)/publish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_publish')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_course_set_manage_course_publish:

                // course_set_manage_course_pre_publish
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/course/(?P<courseId>[^/]++)/pre_publish$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_course_set_manage_course_pre_publish;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_pre_publish')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::prePublishAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_course_set_manage_course_pre_publish:

                // course_set_manage_course_publish_set_title
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/course/(?P<courseId>[^/]++)/publish_set_title$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_course_publish_set_title')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::publishSetTitleAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/items/sort$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_items_sort')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseManageController::courseItemsSortAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/my/c')) {
                if (0 === strpos($pathinfo, '/my/courses')) {
                    if (0 === strpos($pathinfo, '/my/courses/l')) {
                        ...
                        if ($pathinfo === '/my/courses/live/calendar') {
            ...
            if (0 === strpos($pathinfo, '/my/note')) {
                if (0 === strpos($pathinfo, '/my/notebook')) {
                    ...
                    if (preg_match('#^/my/notebook/(?P<courseId>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_notebook_show')), array (  '_controller' => 'AppBundle\\Controller\\My\\NotebookController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/my/note/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_note_delete')), array (  '_controller' => 'AppBundle\\Controller\\My\\NotebookController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_my_note_delete:
        ...
        if (0 === strpos($pathinfo, '/course')) {
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/qrcode$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_qrcode')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::qrcodeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_qrcode:
            ...
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/favorite$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_favorite')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetController::favoriteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/unfavorite$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_unfavorite')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetController::unfavoriteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/exit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_exit')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::exitAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_exit:

            // course_exit_modal
            if ($pathinfo === '/course/show_exit_modal') {
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_create')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_thread_show
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_thread_post
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/post$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_post')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::postAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_thread_edit
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_edit')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::editAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_post_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::deletePostAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_post_edit')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::editPostAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/stick$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_stick')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::stickAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/unstick$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_unstick')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::unstickAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/elite$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_elite')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::eliteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/unelite$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_unelite')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::uneliteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/thread/(?P<threadId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_thread_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ThreadController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_base
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/base$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_base')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::baseAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_cover_crop
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/cover_crop$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_cover_crop')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::coverCropAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_files
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/files$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_files')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_file_show
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/file/(?P<fileId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_file_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/file/(?P<fileId>[^/]++)/convert$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_file_convert')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::convertAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/show/delete/materials$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_delete_materials_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::deleteMaterialsAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/delete/materials$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_delete_materials')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::deleteCourseFilesAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_course_set_manage_delete_materials:

                // course_set_manage_retry_transcode
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/file/(?P<fileId>[^/]++)/retry_transcode$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_course_set_manage_retry_transcode;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_retry_transcode')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetFileManageController::retryTranscodeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/publish$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_publish')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_close
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/close$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_close')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::closeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/review/create$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_review_create')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ReviewController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_review_create:

            // course_review_post
            if (preg_match('#^/course/(?P<courseId>[^/]++)/review/(?P<reviewId>[^/]++)/post$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_review_post')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ReviewController::postAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_review_delete
            if (preg_match('#^/course/(?P<courseId>[^/]++)/review/(?P<reviewId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_review_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\ReviewController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_material_download
            if (preg_match('#^/course/(?P<courseId>[^/]++)/material/(?P<materialId>[^/]++)/download$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_material_download')), array (  '_controller' => 'AppBundle\\Controller\\Course\\MaterialController::downloadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/material/(?P<materialId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_material_delete')), array (  '_controller' => 'AppBundle\\Controller\\Course\\MaterialController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/media')) {
            ...
            if (0 === strpos($pathinfo, '/media/course')) {
                ...
                if (0 === strpos($pathinfo, '/media/coursefile') && preg_match('#^/media/coursefile/(?P<courseId>[^/]++)/choose$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_course_file_choose')), array (  '_controller' => 'AppBundle\\Controller\\FileChooserController::courseFileChooseAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // media_video_import
                if (preg_match('#^/media/course/(?P<courseId>[^/]++)/import$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'media_video_import')), array (  '_controller' => 'AppBundle\\Controller\\FileChooserController::importAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/question$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_question_create
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/question/(?P<type>[^/]++)/create$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_create')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/question/(?P<questionId>[^/]++)/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_update')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/question/delete/(?P<questionId>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_delete')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/question/deletes$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_deletes')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::deletesAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/question/(?P<questionId>[^/]++)/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_preview')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_question_picker
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/question/picker$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_picker')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::questionPickerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_question_picked
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/question/picked$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_picked')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::pickedQuestionAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_question_check
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/question/check$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_check')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::checkAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/show/tasks$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_show_tasks')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::showTasksAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/question/check/num$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_question_check_num')), array (  '_controller' => 'AppBundle\\Controller\\Question\\ManageController::showQuestionTypesNumAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/testpaper$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_set_manage_testpaper_create
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/testpaper/create$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_create')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_update')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/testpaper/info$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_info')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::infoAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/publish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_publish')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/close$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_close')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::closeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_delete')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/deletes$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_deletes')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::deletesAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_preivew')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/questions$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_questions')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::questionsAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/testpaper/(?P<resultId>[^/]++)/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_testpaper_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::checkAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_exam_next_result_check
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/activity/(?P<activityId>[^/]++)/exam/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_exam_next_result_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultNextCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_testpaper_result_graph
            if (preg_match('#^/course/(?P<id>[^/]++)/activity/(?P<activityId>[^/]++)/testpaper/graph$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_testpaper_result_graph')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultGraphAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/testpaper') && preg_match('#^/testpaper/(?P<resultId>[^/]++)/check$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::checkForwordAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/course')) {
            // course_manage_testpaper_check_list
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/testpaper/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_testpaper_check_list')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::checkListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_testpaper_result_list
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/(?P<activityId>[^/]++)/result$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_testpaper_result_list')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_exam_result_anlysis
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/exam/activity/(?P<activityId>[^/]++)/analysis$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_exam_result_anlysis')), array (  '_controller' => 'AppBundle\\Controller\\Course\\TestpaperManageController::resultAnalysisAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_testpaper_questions
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/items$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_testpaper_questions')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::questionsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/course_set') && preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/(?P<type>[^/]++)/build/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_testpaper_build_check')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\ManageController::buildCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/lesson') && preg_match('#^/lesson/(?P<lessonId>[^/]++)/testpaper/(?P<testId>[^/]++)/do$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_do')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\TestpaperController::doTestpaperAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/testpaper')) {
            // testpaper_show
            if (preg_match('#^/testpaper/(?P<resultId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_show')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\TestpaperController::doTestAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/testpaper/result')) {
                ...
                if (preg_match('#^/testpaper/result/(?P<resultId>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_result_show')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\TestpaperController::showResultAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/testpaper/result/(?P<resultId>[^/]++)/submit$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_result_submit')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\TestpaperController::submitTestAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_testpaper_result_submit:

                // testpaper_finish
                if (preg_match('#^/testpaper/result/(?P<resultId>[^/]++)/finish$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_finish')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\TestpaperController::finishTestAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/testpaper/result/(?P<resultId>[^/]++)/suspend$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'testpaper_do_suspend')), array (  '_controller' => 'AppBundle\\Controller\\Testpaper\\TestpaperController::testSuspendAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<courseId>[^/]++)/manage/homework$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_homework')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkManageController::indexAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/course_set')) {
                ...
                if (preg_match('#^/course_set/(?P<id>[^/]++)/manage/homework/question/picker$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_homework_question_picker')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkManageController::questionPickerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course_set/(?P<courseSetId>[^/]++)/manage/homework/question/picked$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_manage_homework_question_picked')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkManageController::pickedQuestionAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/homework/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_homework_check_list')), array (  '_controller' => 'AppBundle\\Controller\\Course\\HomeworkManageController::checkListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_manage_homework_check
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/homework/(?P<resultId>[^/]++)/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_homework_check')), array (  '_controller' => 'AppBundle\\Controller\\Course\\HomeworkManageController::checkAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/lesson') && preg_match('#^/lesson/(?P<lessonId>[^/]++)/homework/(?P<homeworkId>[^/]++)/startDo$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'homework_start_do')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkController::startDoAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/homework')) {
            // homework_show
            if (preg_match('#^/homework/(?P<resultId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'homework_show')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkController::doTestAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            if (0 === strpos($pathinfo, '/homework/result')) {
                // homework_result_show
                if (preg_match('#^/homework/result/(?P<resultId>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'homework_result_show')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkController::showResultAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/homework/result/(?P<resultId>[^/]++)/finish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'homework_finish')), array (  '_controller' => 'AppBundle\\Controller\\HomeworkController::submitAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_homework_finish:
        ...
        if (0 === strpos($pathinfo, '/course') && preg_match('#^/course/(?P<courseId>[^/]++)/manage/exercise/check$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_manage_exercise_check')), array (  '_controller' => 'AppBundle\\Controller\\ExerciseManageController::buildCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        // exercise_start_do
        if (0 === strpos($pathinfo, '/lesson') && preg_match('#^/lesson/(?P<lessonId>[^/]++)/exercise/(?P<exerciseId>[^/]++)/startDo$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'exercise_start_do')), array (  '_controller' => 'AppBundle\\Controller\\ExerciseController::startDoAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/exercise')) {
            // exercise_show
            if (preg_match('#^/exercise/(?P<resultId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'exercise_show')), array (  '_controller' => 'AppBundle\\Controller\\ExerciseController::doTestAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            if (0 === strpos($pathinfo, '/exercise/result')) {
                // exercise_result_show
                if (preg_match('#^/exercise/result/(?P<resultId>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'exercise_result_show')), array (  '_controller' => 'AppBundle\\Controller\\ExerciseController::showResultAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/exercise/result/(?P<resultId>[^/]++)/finish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'exercise_finish')), array (  '_controller' => 'AppBundle\\Controller\\ExerciseController::submitAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_exercise_finish:
        ...
        if (0 === strpos($pathinfo, '/attachment')) {
            ...
            if (0 === strpos($pathinfo, '/attachment/file') && preg_match('#^/attachment/file/(?P<fileId>[^/]++)/show$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_item_show')), array (  '_controller' => 'AppBundle\\Controller\\File\\AttachmentController::fileShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/attachment/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_delete')), array (  '_controller' => 'AppBundle\\Controller\\File\\AttachmentController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/attachment/(?P<id>[^/]++)/preview$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_preview')), array (  '_controller' => 'AppBundle\\Controller\\File\\AttachmentController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/attachment/(?P<id>[^/]++)/player$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_player')), array (  '_controller' => 'AppBundle\\Controller\\File\\AttachmentController::playerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/attachment/(?P<id>[^/]++)/download$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'attachment_download')), array (  '_controller' => 'AppBundle\\Controller\\File\\AttachmentController::downloadAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/classroom')) {
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::indexAction',  '_permission' =>   array (    0 => 'classroom_manage',  ),  '_h5' => false,));
            }

            // classroom_manage_courses
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/courses$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_courses')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::coursesAction',  '_permission' =>   array (    0 => 'classroom_manage_courses',  ),  '_h5' => false,));
            }

            // classroom_manage_course_remove
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/course/(?P<courseId>[^/]++)/remove$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_course_remove')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::removeCourseAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_courses_select
            if (preg_match('#^/classroom/(?P<id>[^/]++)/courses/select$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_courses_select')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::coursesSelectAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_set_info
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/set_info$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_set_info')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::setInfoAction',  '_permission' =>   array (    0 => 'classroom_manage_set_info',  ),  '_h5' => false,));
            }

            // classroom_manage_set_picture
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/set_picture$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_set_picture')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::setPictureAction',  '_permission' =>   array (    0 => 'classroom_manage_set_picture',  ),  '_h5' => false,));
            }

            // classroom_manage_picture_crop
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/picture_crop$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_picture_crop')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::pictureCropAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_set_price
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/price/set$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_set_price')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::setPriceAction',  '_permission' =>   array (    0 => 'classroom_manage_set_price',  ),  '_h5' => false,));
            }

            // classroom_manage_students
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/students$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_students')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::studentsAction',  '_permission' =>   array (    0 => 'classroom_manage_students',  ),  '_h5' => false,));
            }

            // classroom_manage_aduitor
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/aduitor$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_aduitor')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::aduitorAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_record
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/record/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_record')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::recordAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_service
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/service$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_service')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::serviceAction',  '_permission' =>   array (    0 => 'classroom_manage_service',  ),  '_h5' => false,));
            }

            // classroom_manage_teachers
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/teachers$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_teachers')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::teachersAction',  '_permission' =>   array (    0 => 'classroom_manage_teachers',  ),  '_h5' => false,));
            }

            // classroom_manage_headteacher
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/headteacher$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_headteacher')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::headteacherAction',  '_permission' =>   array (    0 => 'classroom_manage_headteacher',  ),  '_h5' => false,));
            }

            // classroom_manage_assistants
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/assistants$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_assistants')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::assistantsAction',  '_permission' =>   array (    0 => 'classroom_manage_assistants',  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/publish$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_publish')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/close$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_close')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::closeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/manage/student/(?P<userId>[^/]++)/remark$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_remark')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::remarkAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/manage/student/(?P<userId>[^/]++)/remove$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_remove')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::removeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/student/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_create')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_student_check
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/student_check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_check')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::checkStudentAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_student_export_datas
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/student/export/(?P<role>[^/]++)/datas$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_export_datas')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::exportDatasAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_student_export_csv
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/student/export$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_export_csv')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::exportCsvAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_student_import
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/student/import$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_import')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::importUsersAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/student/importing$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_student_to_base')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::excelDataImportAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/testpaper/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_testpaper')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::testpaperAction',  '_permission' =>   array (    0 => 'classroom_manage_testpaper',  ),  '_h5' => false,));
            }

            // classroom_manage_testpaper_result_list
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/testpaper/(?P<testpaperId>[^/]++)/(?P<activityId>[^/]++)/result$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_testpaper_result_list')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::testpaperResultListAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_testpaper_check
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/testpaper/(?P<resultId>[^/]++)/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_testpaper_check')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::testpaperCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_exam_result_anlysis
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/exam/activity/(?P<activityId>[^/]++)/analysis$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_exam_result_anlysis')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::resultAnalysisAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_exam_next_result_check
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/activity/(?P<activityId>[^/]++)/exam/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_exam_next_result_check')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::resultNextCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_testpaper_result_graph
            if (preg_match('#^/classroom/(?P<id>[^/]++)/activity/(?P<activityId>[^/]++)/testpaper/graph$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_testpaper_result_graph')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::resultGraphAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_homework
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/homework/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_homework')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::homeworkAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_homework_check
            if (preg_match('#^/classroom/(?P<id>[^/]++)/manage/homework/(?P<resultId>[^/]++)/check$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_homework_check')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::homeworkCheckAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/manage/students/(?P<userId>[^/]++)/defined_show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_students_defined_show')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::studentDefinedShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_students_show
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/manage/students/(?P<userId>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_students_show')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::studentShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_manage_member_deadline
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/manage/member/(?P<userId>[^/]++)/deadline$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_manage_member_deadline')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomManageController::setClassroomMemberDeadlineAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_member_deadline_reach
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/member/deadline/reach$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_member_deadline_reach')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::deadlineReachAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/classroom/explore') && preg_match('#^/classroom/explore(?:/(?P<category>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_explore')), array (  '_controller' => 'AppBundle\\Controller\\ExploreController::classroomAction',  'category' => '',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_show
            if (preg_match('#^/classroom/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_show')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::showAction',  '_permission' =>   array (  ),  '_h5' => true,));
            }

            // classroom_qrcode
            if (preg_match('#^/classroom/(?P<id>[^/]++)/qrcode$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_qrcode')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::qrcodeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_reviews
            if (preg_match('#^/classroom/(?P<id>[^/]++)/review$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_reviews')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ReviewController::listAction',  '_permission' =>   array (  ),  '_h5' => true,));
            }

            // classroom_review_create
            if (preg_match('#^/classroom/(?P<id>[^/]++)/review/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_review_create')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ReviewController::createAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_review_post
            if (preg_match('#^/classroom/(?P<id>[^/]++)/review/(?P<reviewId>[^/]++)/post$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_review_post')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ReviewController::postAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/classroom/review') && preg_match('#^/classroom/review/(?P<reviewId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_review_delete')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ReviewController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_introductions
            if (preg_match('#^/classroom/(?P<id>[^/]++)/introduction$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_introductions')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::introductionAction',  '_permission' =>   array (  ),  '_h5' => true,));
            }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/buy$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_buy')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomBuyController::buyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_classroom_buy:
            ...
            if (0 === strpos($pathinfo, '/classroom/sign')) {
                ...
                if (preg_match('#^/classroom/sign/(?P<classroomId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_sign')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::signAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // classroom_signed_records
                if (preg_match('#^/classroom/sign/(?P<classroomId>[^/]++)/records$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_signed_records')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::getSignedRecordsByPeriodAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (preg_match('#^/classroom/(?P<id>[^/]++)/becomeAuditor$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_become_auditor')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::becomeAuditorAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_exit
            if (preg_match('#^/classroom/(?P<id>[^/]++)/exit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_exit')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::exitAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_canview
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/canview$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_canview')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::canviewAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_courses
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/courses$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_courses')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\CourseController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_threads
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/threads$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_threads')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomThreadController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_thread_create
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/thread/(?P<type>[^/]++)/create$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_thread_create')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomThreadController::createAction',  'type' => 'discussion',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_thread_show
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/thread/(?P<threadId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_thread_show')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomThreadController::showAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_thread_update
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/thread/(?P<threadId>[^/]++)/update$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_thread_update')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomThreadController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_vip_buy
            if (preg_match('#^/classroom/(?P<id>[^/]++)/vip_buy$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_vip_buy')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::becomeStudentAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_thread_members_become
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/thread/(?P<threadId>[^/]++)/members/become$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_thread_members_become')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ThreadMemberController::becomeAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/thread/(?P<threadId>[^/]++)/member/(?P<memberId>[^/]++)/quit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_thread_members_quit')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ThreadMemberController::quitAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_headteacher_match
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/headteacher/match$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_headteacher_match')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\UtilityController::headteacherMatchAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_assistants_match
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/assistants/match$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_assistants_match')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\UtilityController::assistantsMatchAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_courses_pick
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/course/pick$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_courses_pick')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\CourseController::pickAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_course_search
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/course/search$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_course_search')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\CourseController::searchAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/my/teaching/classroom/threads') && preg_match('#^/my/teaching/classroom/threads/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_teaching_classroom_threads')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\ClassroomController::classroomThreadsAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        if (0 === strpos($pathinfo, '/classroom')) {
            // classroom_course_notes_list
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/courses/notes$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_course_notes_list')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\CourseNoteController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_teachers
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/teachers/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_teachers')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\TeacherController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_teacherIds_catch
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/teacherIds/catch$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_teacherIds_catch')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\TeacherController::catchIdsAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classroom_buy_hint
            if (0 === strpos($pathinfo, '/classroom/courses') && preg_match('#^/classroom/courses/(?P<courseId>[^/]++)/buy/hint$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classroom_buy_hint')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\CourseTaskController::buyHintAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // classrom_course_tasks_list
            if (preg_match('#^/classroom/(?P<classroomId>[^/]++)/course/(?P<courseId>[^/]++)/tasks/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'classrom_course_tasks_list')), array (  '_controller' => 'AppBundle\\Controller\\Classroom\\CourseTaskController::listAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/material')) {
            if (0 === strpos($pathinfo, '/material/lib')) {
                ...
                if (0 === strpos($pathinfo, '/material/lib/file') && preg_match('#^/material/lib/file/(?P<fileId>[^/]++)/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_lib_file_preview')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/materiallib') && preg_match('#^/materiallib/(?P<fileId>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_edit')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::editAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_material_edit:
            ...
            if (0 === strpos($pathinfo, '/material/lib')) {
                ...
                if (preg_match('#^/material/lib/(?P<fileId>[^/]++)/player$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_lib_file_player')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::playerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // material_reconvert
                if (preg_match('#^/material/lib/(?P<globalId>[^/]++)/reconvert$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_reconvert')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::reconvertAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            if (0 === strpos($pathinfo, '/announcement') && preg_match('#^/announcement/(?P<id>[^/]++)/opreate/global/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'announcement_global_show')), array (  '_controller' => 'AppBundle\\Controller\\AnnouncementController::globalShowAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/material')) {
            if (0 === strpos($pathinfo, '/material/lib')) {
                ...
                if (preg_match('#^/material/lib/(?P<globalId>[^/]++)/thumbnail/generate$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_thumbnail_generate')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::generateThumbnailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // material_lib_file_detail
                if (preg_match('#^/material/lib/(?P<fileId>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_lib_file_detail')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/materiallib')) {
                ...
                if (preg_match('#^/materiallib/(?P<fileId>[^/]++)/download$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_download')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::downloadAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/materiallib/(?P<fileId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_delete')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_material_delete:
            ...
            if (0 === strpos($pathinfo, '/materiallib') && preg_match('#^/materiallib/(?P<fileId>[^/]++)/unshare$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'material_unshare')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\MaterialLibController::unshareAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/global_file')) {
            ...
            if (preg_match('#^/global_file/(?P<globalId>[^/]++)/player$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'global_file_document_player')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\GlobalFilePlayerController::globalDocumentPlayerAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // global_file_hls_playlist
            if (preg_match('#^/global_file/(?P<globalId>[^/]++)/playlist/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'global_file_hls_playlist')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\GlobalFilePlayerController::playlistAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // global_file_hls_stream
            if (preg_match('#^/global_file/(?P<globalId>[^/]++)/stream/(?P<level>[^/]++)/(?P<token>[^/\\.]++)\\.m3u8$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'global_file_hls_stream')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\GlobalFilePlayerController::streamAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // global_file_hls_clef
            if (preg_match('#^/global_file/(?P<globalId>[^/]++)/clef/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'global_file_hls_clef')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\GlobalFilePlayerController::clefAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // global_file_document
            if (preg_match('#^/global_file/(?P<globalId>[^/]++)/document$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'global_file_document')), array (  '_controller' => 'AppBundle\\Controller\\MaterialLib\\GlobalFilePlayerController::documentAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/swithOrg') && preg_match('#^/swithOrg/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'switch_org')), array (  '_controller' => 'AppBundle\\Controller\\OrgController::switchOrgAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/my/course') && preg_match('#^/my/course/(?P<id>[^/]++)(?:/(?P<tab>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'my_course_show')), array (  '_controller' => 'AppBundle\\Controller\\My\\CourseController::showAction',  'tab' => 'tasks',  '_permission' =>   array (  ),  '_h5' => true,));
        }

        if (0 === strpos($pathinfo, '/course')) {
            // course_member_expired
            if (preg_match('#^/course/(?P<id>[^/]++)/member/expired$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_member_expired')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::memberExpiredAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_member_deadline_reach
            if (preg_match('#^/course/(?P<id>[^/]++)/member/deadline/reach$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_member_deadline_reach')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::deadlineReachAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/buy$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_buy')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseBuyController::buyAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_buy:
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)(?:/(?P<tab>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::showAction',  'tab' => 'summary',  '_permission' =>   array (  ),  '_h5' => true,));
            }

            // course_task_paging_show
            if (preg_match('#^/course/(?P<courseId>[^/]++)/tasks/paging$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_paging_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseController::tasksByPagingAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/archive/course')) {
            ...
            if (preg_match('#^/archive/course/(?P<courseSetId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_archive_show')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetController::archiveDetailAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // course_set_archive_task
            if (preg_match('#^/archive/course/(?P<courseSetId>[^/]++)/lesson/(?P<taskId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_archive_task')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetController::archiveTaskAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/c')) {
            ...
            if (0 === strpos($pathinfo, '/course')) {
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/marker/manage$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_marker_manage')), array (  '_controller' => 'AppBundle\\Controller\\MarkerController::manageAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // course_task_marker_manage_preview
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/marker/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_marker_manage_preview')), array (  '_controller' => 'AppBundle\\Controller\\MarkerController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                if (0 === strpos($pathinfo, '/course/task')) {
                    // course_task_marker_show
                    if (preg_match('#^/course/task/(?P<taskId>[^/]++)/marker/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_marker_show')), array (  '_controller' => 'AppBundle\\Controller\\MarkerController::showMarkersAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                    // course_task_marker_metas
                    if (preg_match('#^/course/task/(?P<mediaId>[^/]++)/marker/metas$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_marker_metas')), array (  '_controller' => 'AppBundle\\Controller\\MarkerController::markerMetasAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/marker/merge$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_marker_merge')), array (  '_controller' => 'AppBundle\\Controller\\MarkerController::mergeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/marker/update$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_marker_update')), array (  '_controller' => 'AppBundle\\Controller\\MarkerController::updateMarkerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/question/(?P<id>[^/]++)/marker/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_question_marker_preview')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::questionMakerPreviewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/course/task/media')) {
                    ...
                    if (preg_match('#^/course/task/media/(?P<mediaId>[^/]++)/question_markers/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_markers_show')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::showQuestionMakersAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/question_marker/add$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_marker_add')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::addQuestionMarkerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/question_marker/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_marker_delete')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::deleteQuestionMarkerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/question_marker/sort$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_marker_sort')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::sortQuestionMarkerAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/question_marker/list$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_marker_list')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::questionAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/course/(?P<courseId>[^/]++)/task/(?P<taskId>[^/]++)/question_marker/search$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_marker_search')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::searchAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/callback') && preg_match('#^/callback/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'callback')), array (  '_controller' => 'AppBundle\\Controller\\Callback\\EndpointController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
        ...
        if (0 === strpos($pathinfo, '/marketing')) {
            if (0 === strpos($pathinfo, '/marketing/user/login')) {
                // marketing_user_login
                if ($pathinfo === '/marketing/user/login') {
            ...
            // marketing_activity
            if (0 === strpos($pathinfo, '/marketing/activity') && preg_match('#^/marketing/activity/(?P<activityId>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'marketing_activity')), array (  '_controller' => 'AppBundle\\Controller\\MarketingController::activityAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

        }

        // export
        if (0 === strpos($pathinfo, '/export') && preg_match('#^/export/(?P<name>[^/]++)(?:/(?P<type>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'export')), array (  '_controller' => 'AppBundle\\Controller\\Export\\ExportController::exportAction',  'type' => 'csv',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        // online_sample
        if ($pathinfo === '/online/sample') {
        ...
        // pre_export
        if (0 === strpos($pathinfo, '/pre/export') && preg_match('#^/pre/export/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'pre_export')), array (  '_controller' => 'AppBundle\\Controller\\Export\\ExportController::preExportAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        // try_export
        if (0 === strpos($pathinfo, '/try/export') && preg_match('#^/try/export/(?P<name>[^/]++)(?:/(?P<limit>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'try_export')), array (  '_controller' => 'AppBundle\\Controller\\Export\\ExportController::tryExportAction',  'limit' => '',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        // member_operation_record
        if (0 === strpos($pathinfo, '/member') && preg_match('#^/member/(?P<operatType>[^/]++)/record/(?P<targetType>[^/]++)/(?P<targetId>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'member_operation_record')), array (  '_controller' => 'AppBundle\\Controller\\MemberOperationRecordController::showRecordAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }

        // order_calculate_price
        if ($pathinfo === '/order/price/calculate') {
        ...
        if (0 === strpos($pathinfo, '/c')) {
            // course_sort
            if (0 === strpos($pathinfo, '/courseset') && preg_match('#^/courseset/(?P<courseSetId>[^/]++)/sort$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_course_sort;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_sort')), array (  '_controller' => 'AppBundle\\Controller\\Course\\CourseSetManageController::courseSortAction',  'limit' => '',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            not_course_sort:

            // client_time_check
            if ($pathinfo === '/client_time_check') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
        ...
        // drag_captcha
        if (0 === strpos($pathinfo, '/drag_captcha') && preg_match('#^/drag_captcha/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'drag_captcha')), array (  '_controller' => 'AppBundle\\Controller\\CommonController::dragCaptchaAction',  '_permission' =>   array (  ),  '_h5' => false,));
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/course') && preg_match('#^/admin/course/(?P<courseId>[^/]++)/question/(?P<questionId>[^/]++)/remindTeachers$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_question_remind_teachers')), array (  '_controller' => 'CustomBundle\\Controller\\Admin\\DefaultController::questionRemindTeachersAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/user/statistic') && preg_match('#^/admin/user/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_statistic')), array (  '_controller' => 'CustomBundle\\Controller\\Admin\\DefaultController::userStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/task/learn/statistic') && preg_match('#^/admin/task/learn/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_task_learn_statistic')), array (  '_controller' => 'CustomBundle\\Controller\\Admin\\DefaultController::completedTaskStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/study/statistic') && preg_match('#^/admin/study/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_study_statistic')), array (  '_controller' => 'CustomBundle\\Controller\\Admin\\DefaultController::studyStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/order/statistic') && preg_match('#^/admin/order/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_statistic')), array (  '_controller' => 'CustomBundle\\Controller\\Admin\\DefaultController::orderStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/course/explore') && preg_match('#^/admin/course/explore/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_explore')), array (  '_controller' => 'CustomBundle\\Controller\\Admin\\DefaultController::courseExploreAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/opencourse')) {
                ...
                if (preg_match('#^/admin/opencourse/(?P<id>[^/]++)/analysis/referer/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_opencourse_analysis_referer_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseAnalysisController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/opencourse/(?P<id>[^/]++)/analysis/referer/detailList$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_opencourse_analysis_referer_detail_list')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseAnalysisController::detailListAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/opencourse/(?P<courseId>[^/]++)/analysis/conversion/result$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_opencourse_analysis_conversion_result')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseAnalysisController::conversionResultAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/content')) {
                ...
                if (0 === strpos($pathinfo, '/admin/content/create') && preg_match('#^/admin/content/create/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_create')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ContentController::createAction',  '_permission' =>   array (    0 => 'admin_content',  ),  '_h5' => false,));
                }

                // admin_content_edit
                if (preg_match('#^/admin/content/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ContentController::editAction',  '_permission' =>   array (    0 => 'admin_content',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/content/(?P<id>[^/]++)/publish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_publish')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ContentController::publishAction',  '_permission' =>   array (    0 => 'admin_content',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/content/(?P<id>[^/]++)/trash$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_trash')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ContentController::trashAction',  '_permission' =>   array (    0 => 'admin_content',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/content/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ContentController::deleteAction',  '_permission' =>   array (    0 => 'admin_content',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/block')) {
                if (0 === strpos($pathinfo, '/admin/block/list')) {
                    ...
                    if (preg_match('#^/admin/block/list\\-(?P<category>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::indexAction',  '_permission' =>   array (    0 => 'admin_block',  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/admin/block/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/block/code')) {
                    ...
                    if (preg_match('#^/admin/block/code/(?P<id>[^/]++)/check/foredit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_code_check_foredit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::checkBlockTemplateCodeForEditAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/admin/block/(?P<blockTemplateId>[^/]++)/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_update')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_block_edit
                if (preg_match('#^/admin/block/(?P<blockTemplateId>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::editAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/blockTemplate') && preg_match('#^/admin/blockTemplate/(?P<blockTemplateId>[^/]++)/visual/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_visual_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::visualEditAction',  '_permission' =>   array (    0 => 'admin_block_visual_edit',  ),  '_h5' => false,));
                }

                // admin_block_visual_view_data
                if (preg_match('#^/admin/block/(?P<blockTemplateId>[^/]++)/data/view$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_visual_view_data')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::dataViewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/blockTemplate') && preg_match('#^/admin/blockTemplate/(?P<blockTemplateId>[^/]++)/visual/edit/history$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_visual_edit_history')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::visualHistoryAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_block_recovery
                if (preg_match('#^/admin/block/(?P<blockTemplateId>[^/]++)/history/(?P<historyId>[^/]++)/recovery$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_recovery')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::recoveryAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/block/histroy') && preg_match('#^/admin/block/histroy/(?P<blockId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_history_data')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::blockHistoriesDataAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_block_picture_upload
                if (preg_match('#^/admin/block/(?P<blockId>[^/]++)/picture/upload$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_picture_upload')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::uploadAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_block_picture_preview
                if (preg_match('#^/admin/block/(?P<blockId>[^/]++)/picture/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_block_picture_preview')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::picPreviewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/blockhistory') && preg_match('#^/admin/blockhistory/(?P<id>[^/]++)/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_blockhistory_preview')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlockController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/tag')) {
                ...
                if (preg_match('#^/admin/tag/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_tag_update')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\TagController::updateAction',  '_permission' =>   array (    0 => 'admin_course_tag_manage',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/tag/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_tag_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\TagController::deleteAction',  '_permission' =>   array (    0 => 'admin_course_tag_manage',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/tag/group')) {
                    ...
                    if (preg_match('#^/admin/tag/group/(?P<groupId>[^/]++)/update$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_tag_group_update')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\TagGroupController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/tag/group/(?P<tagId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_tag_group_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\TagGroupController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/user')) {
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_show')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::showAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
                }

                // admin_user_edit
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::editAction',  '_permission' =>   array (    0 => 'admin_user_edit',  ),  '_h5' => false,));
                }

                // admin_user_org_update
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/org/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_org_update')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::orgUpdateAction',  '_permission' =>   array (    0 => 'admin_user_org_update',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/lock$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_lock')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::lockAction',  '_permission' =>   array (    0 => 'admin_user_lock',  ),  '_h5' => false,));
                }
                not_admin_user_lock:
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/unlock$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_unlock')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::unlockAction',  '_permission' =>   array (    0 => 'admin_user_unlock',  ),  '_h5' => false,));
                }
                not_admin_user_unlock:

                // admin_user_roles
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/roles$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_roles')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::rolesAction',  '_permission' =>   array (    0 => 'admin_user_roles',  ),  '_h5' => false,));
                }

                // admin_user_avatar
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/avatar$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_avatar')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::avatarAction',  '_permission' =>   array (    0 => 'admin_user_avatar',  ),  '_h5' => false,));
                }

                // admin_user_avatar_crop
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/avatar/crop$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_avatar_crop')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::avatarCropAction',  '_permission' =>   array (    0 => 'admin_user_avatar',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/teacher')) {
                ...
                if (preg_match('#^/admin/teacher/(?P<id>[^/]++)/promote$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_teacher_promote')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\TeacherController::promoteAction',  '_permission' =>   array (    0 => 'admin_teacher_promote',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/teacher/(?P<id>[^/]++)/promote/cancel$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_teacher_promote_cancel')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\TeacherController::promoteCancelAction',  '_permission' =>   array (    0 => 'admin_teacher',    1 => 'admin_teacher_promote',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/user')) {
                ...
                if (preg_match('#^/admin/user/(?P<userId>[^/]++)/change/password$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_change_password')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::changePasswordAction',  '_permission' =>   array (    0 => 'admin_user_change_password',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/send_passwordreset_email$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_send_passwordreset_email')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::sendPasswordResetEmailAction',  '_permission' =>   array (    0 => 'admin_user_send_passwordreset_email',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/user/(?P<id>[^/]++)/send_emailverify_email$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_send_emailverify_email')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserController::sendEmailVerifyEmailAction',  '_permission' =>   array (    0 => 'admin_user_send_emailverify_email',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/setting/navigation')) {
                ...
                if (preg_match('#^/admin/setting/navigation/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_navigation_update')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\NavigationController::updateAction',  '_permission' =>   array (    0 => 'admin_top_navigation',    1 => 'admin_foot_navigation',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/setting/navigation/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_navigation_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\NavigationController::deleteAction',  '_permission' =>   array (    0 => 'admin_top_navigation',    1 => 'admin_foot_navigation',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/review')) {
                ...
                if (preg_match('#^/admin/review/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_review_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseReviewController::deleteAction',  '_permission' =>   array (    0 => 'admin_course_review_tab',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/note')) {
                ...
                if (preg_match('#^/admin/note/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_note_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseNoteController::deleteAction',  '_permission' =>   array (    0 => 'admin_course_note_manage',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/course_set')) {
                ...
                if (preg_match('#^/admin/course_set/(?P<filter>[^/]++)/index$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::indexAction',  'filter' => 'normal',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }

                // admin_course_list
                if (preg_match('#^/admin/course_set/(?P<id>[^/]++)/course/list$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_list')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::courseListAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }

                // admin_course_set_clone_by_web
                if (preg_match('#^/admin/course_set/(?P<courseSetId>[^/]++)/clone_by_web$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_course_set_clone_by_web;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_clone_by_web')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cloneByWebAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }
                not_admin_course_set_clone_by_web:

                // admin_course_set_clone_by_crontab
                if (preg_match('#^/admin/course_set/(?P<courseSetId>[^/]++)/clone_by_crontab$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_course_set_clone_by_crontab;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_clone_by_crontab')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cloneByCrontabAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/course_set/(?P<id>[^/]++)/delete(?:/(?P<type>[^/]++))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::deleteAction',  'type' => '',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }

                // admin_course_set_clone
                if (preg_match('#^/admin/course_set/(?P<courseSetId>[^/]++)/clone$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_clone')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cloneAction',  'type' => 'web',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/open/course') && preg_match('#^/admin/open/course/(?P<courseId>[^/]++)/delete(?:/(?P<type>[^/]++))?$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_open_course_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseController::deleteAction',  'type' => '',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/c')) {
                ...
                if (0 === strpos($pathinfo, '/admin/course_set') && preg_match('#^/admin/course_set/(?P<id>[^/]++)/publish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_publish')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::publishAction',  '_permission' =>   array (    0 => 'admin_course_manage',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/open/course') && preg_match('#^/admin/open/course/(?P<id>[^/]++)/publish$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_open_course_publish')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseController::publishAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/course_set') && preg_match('#^/admin/course_set/(?P<id>[^/]++)/close$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_close')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::closeAction',  '_permission' =>   array (    0 => 'admin_course_set_close',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/open/course')) {
                ...
                if (preg_match('#^/admin/open/course/(?P<id>[^/]++)/close$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_open_course_close')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseController::closeAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/open/course/(?P<id>[^/]++)/recommend$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_open_course_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseController::recommendAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/open/course/(?P<id>[^/]++)/recommend/cancel/(?P<target>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_open_course_cancel_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseController::cancelRecommendAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/course')) {
                if (0 === strpos($pathinfo, '/admin/course_set')) {
                    ...
                    if (preg_match('#^/admin/course_set/(?P<id>[^/]++)/recommend$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::recommendAction',  '_permission' =>   array (    0 => 'admin_course_set_recommend_list',    1 => 'admin_course_set_recommend',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/course_set/(?P<id>[^/]++)/recommend/cancel/(?P<target>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_cancel_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::cancelRecommendAction',  '_permission' =>   array (    0 => 'admin_course_set_recommend_list',    1 => 'admin_course_set_cancel_recommend',  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/course_set')) {
                    ...
                    if (preg_match('#^/admin/course_set/(?P<filter>[^/]++)/data$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_data')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::dataAction',  'filter' => 'normal',  '_permission' =>   array (    0 => 'admin_course_set_data',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/course_set/detail/data') && preg_match('#^/admin/course_set/detail/data/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_set_detail_data')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::detailDataAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/courses/data') && preg_match('#^/admin/courses/data/(?P<courseSetId>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_courses_data')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseController::coursesDataAction',  '_permission' =>   array (    0 => 'admin_course_set_data',  ),  '_h5' => false,));
                }

            }

            // admin_order_manage
            if ($pathinfo === '/admin/order/manage') {
            ...
            if (0 === strpos($pathinfo, '/admin/livecourse') && preg_match('#^/admin/livecourse/(?P<status>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_live_course')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\LiveCourseController::indexAction',  '_permission' =>   array (    0 => 'admin_live_course_manage',  ),  '_h5' => false,));
            }

            // admin_open_course
            if (0 === strpos($pathinfo, '/admin/open/course') && preg_match('#^/admin/open/course(?:/(?P<filter>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_open_course')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OpenCourseController::indexAction',  'filter' => 'open',  '_permission' =>   array (    0 => 'admin_open_course',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/order')) {
                ...
                if (preg_match('#^/admin/order/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_order_adjust_price
                if (preg_match('#^/admin/order/(?P<id>[^/]++)/adjust_price$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_adjust_price')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderController::adjustPriceAction',  '_permission' =>   array (    0 => 'admin_finance',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/order/refund')) {
                    ...
                    if (preg_match('#^/admin/order/refund/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_refund_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderRefundController::refundDetailAction',  '_permission' =>   array (    0 => 'admin_finance',  ),  '_h5' => false,));
                    }

                }

                // admin_order_audit_refund
                if (preg_match('#^/admin/order/(?P<refundId>[^/]++)/audit_refund$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_audit_refund')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrderRefundController::auditRefundAction',  '_permission' =>   array (    0 => 'admin_finance',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/setting/site')) {
                ...
                if ($pathinfo === '/admin/setting/site/save') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
            ...
            if (0 === strpos($pathinfo, '/admin/discovery_column')) {
                ...
                if (preg_match('#^/admin/discovery_column/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_discovery_column_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DiscoveryColumnController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/discovery_column/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_discovery_column_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DiscoveryColumnController::editAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_discovery_column_title_check
                if (preg_match('#^/admin/discovery_column/(?P<id>[^/]++)/title_check$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_discovery_column_title_check')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DiscoveryColumnController::checkTitleAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/setting/mobile')) {
                ...
                if (0 === strpos($pathinfo, '/admin/setting/mobile_iap_product')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/setting/mobile_iap_product_delete') && preg_match('#^/admin/setting/mobile_iap_product_delete/(?P<productId>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_mobile_iap_product_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SettingController::mobileIapProductDeleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/operation/mobile/picture/upload') && preg_match('#^/admin/operation/mobile/picture/upload/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_mobile_picture_upload')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\MobileController::mobilePictureUploadAction',  '_permission' =>   array (    0 => 'admin_operation_mobile_banner_manage',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/setting/mobile/picture/upload') && preg_match('#^/admin/setting/mobile/picture/upload/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_mobile_picture_upload')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SettingController::mobilePictureUploadAction',  '_permission' =>   array (    0 => 'admin_setting_mobile_settings',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/operation/mobile/picture/remove') && preg_match('#^/admin/operation/mobile/picture/remove/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_mobile_picture_remove')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\MobileController::mobilePictureRemoveAction',  '_permission' =>   array (    0 => 'admin_operation_mobile_banner_manage',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                ...
                if (0 === strpos($pathinfo, '/admin/setting/mobile/picture/remove') && preg_match('#^/admin/setting/mobile/picture/remove/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_mobile_picture_remove')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SettingController::mobilePictureRemoveAction',  '_permission' =>   array (    0 => 'admin_setting_mobile_settings',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                if (0 === strpos($pathinfo, '/admin/setting/cloud')) {
                    ...
                    if ($pathinfo === '/admin/setting/cloud/normal/video/delete') {
            ...
            if (0 === strpos($pathinfo, '/admin/theme')) {
                ...
                if (preg_match('#^/admin/theme/(?P<uri>[^/]++)/manage$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_theme_manage')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ThemeController::manageIndexAction',  '_permission' =>   array (    0 => 'admin_setting_theme',  ),  '_h5' => false,));
                }

                // admin_reset_currentTheme_config
                if (preg_match('#^/admin/theme/(?P<uri>[^/]++)/config/reset$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_reset_currentTheme_config')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ThemeController::resetConfigAction',  '_permission' =>   array (    0 => 'admin_setting_theme',  ),  '_h5' => false,));
                }

                // admin_save_themes_config
                if ($pathinfo === '/admin/theme/config/save') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                ...
                if (preg_match('#^/admin/theme/(?P<uri>[^/]++)/config/confirm$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_confirm_themes_config')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ThemeController::confirmConfigAction',  '_permission' =>   array (    0 => 'admin_setting_theme',  ),  '_h5' => false,));
                }

                // admin_themes_show
                if ($pathinfo === '/admin/theme/show') {
                ...
                if ($pathinfo === '/admin/theme/config/edit') {
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                ...
                if ($pathinfo === '/admin/setting/message') {
            ...
            if (0 === strpos($pathinfo, '/admin/mock')) {
                // admin_mocked
                if ($pathinfo === '/admin/mock') {
                ...
                if (0 === strpos($pathinfo, '/admin/mock/distributor_')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/mock/distributor_token') && preg_match('#^/admin/mock/distributor_token/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_mocked_distributor_token')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\MockController::mockDistributorTokenAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }

                    // admin_mocked_distributor_get_post_data
                    if ($pathinfo === '/admin/mock/distributor_get_post_data') {
                    ...
                    if ($pathinfo === '/admin/mock/distributor_post_data') {
                        if ($this->context->getMethod() != 'POST') {
                            $allow[] = 'POST';
                ...
                if ($pathinfo === '/admin/mock/marketing_post_data') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                ...
                if ($pathinfo === '/admin/mock/post_data_version_3') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                ...
                if ($pathinfo === '/admin/mock/download_token') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                if (0 === strpos($pathinfo, '/admin/setting/optimize')) {
                    ...
                    if ($pathinfo === '/admin/setting/optimize/remove-unusedfiles') {
                        return array (  '_controller' => 'AppBundle\\Controller\\Admin\\OptimizeController::removeUnusedFilesAction',  '_route' => 'admin_optimize_remove_upload_files',  '_permission' =>   array (    0 => 'admin_optimize_settings',  ),  '_h5' => false,);
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/setting/logs')) {
                    ...
                    if ($pathinfo === '/admin/setting/logs/logFieldChange') {
                ...
                if (0 === strpos($pathinfo, '/admin/setting/logs')) {
                    ...
                    if ($pathinfo === '/admin/setting/logs/usernameMatchUsers') {
                    ...
                    // admin_logs_old
                    if ($pathinfo === '/admin/setting/logs/old') {
            ...
            if (0 === strpos($pathinfo, '/admin/cloud')) {
                ...
                if (0 === strpos($pathinfo, '/admin/cloud/service') && preg_match('#^/admin/cloud/service/(?P<type>[^/]++)/overview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_service_overview')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudController::serviceOverviewAction',  '_permission' =>   array (    0 => 'admin_my_cloud_overview',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/cloud/(?P<type>[^/]++)/buy$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_buy')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudController::buyAction',  '_permission' =>   array (    0 => 'admin_my_cloud_overview',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/cloud/(?P<type>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_show')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudController::cloudShowAction',  'type' => 'video',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_cloud_email_buy
                if (preg_match('#^/admin/cloud/(?P<type>[^/]++)/buy/custom$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_email_buy')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudController::emailBuyAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/cloud')) {
                ...
                if ($pathinfo === '/admin/cloud/doc') {
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudController::docAction',  '_route' => 'admin_cloud_doc',  '_permission' =>   array (    0 => 'admin_my_cloud_overview',  ),  '_h5' => false,);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/app/center') && preg_match('#^/admin/app/center(?:/(?P<postStatus>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_center')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppController::centerAction',  'postStatus' => 'all',  '_permission' =>   array (    0 => 'admin_app_center',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/cloud_file')) {
                ...
                if (preg_match('#^/admin/cloud_file/(?P<globalId>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_file_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudFileController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/cloud_file/(?P<globalId>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_file_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudFileController::editAction',  'fields' => '',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_admin_cloud_file_edit:

                // admin_cloud_file_preview
                if (preg_match('#^/admin/cloud_file/(?P<globalId>[^/]++)/preview$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_file_preview')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudFileController::previewAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_cloud_file_reconvert
                if (preg_match('#^/admin/cloud_file/(?P<globalId>[^/]++)/reconvert$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_file_reconvert')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudFileController::reconvertAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_cloud_file_download
                if (preg_match('#^/admin/cloud_file/(?P<globalId>[^/]++)/download$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_file_download')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudFileController::downloadAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/cloud_file/(?P<globalId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_file_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CloudFileController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/app')) {
                ...
                if (0 === strpos($pathinfo, '/admin/app/installed') && preg_match('#^/admin/app/installed/(?P<postStatus>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_installed')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppController::installedAction',  '_permission' =>   array (    0 => 'admin_app_installed',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/app')) {
                ...
                if (0 === strpos($pathinfo, '/admin/app/package_update')) {
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/modal$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_modal')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::modalAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/check_environment$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_check_environment')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::checkEnvironmentAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/check_depends$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_check_depends')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::checkDependsAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/check_lasterror$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_check_last_error')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::checklastErrorAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/backup_file$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_backup_file')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::backupFileAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/backup_db$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_backup_db')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::backupDbAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/download_extract$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_download_and_extract')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::downloadAndExtractAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/check_download_extract$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_check_download_and_extract')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::checkDownloadAndExtractAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/app/package_update/(?P<id>[^/]++)/begin_upgrade$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_begin_upgrade')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::beginUpgradeAction',  '_permission' =>   array (    0 => 'admin_app_center',    1 => 'admin_app_installed',    2 => 'admin_app_upgrades',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/app/package_update/check/newest/code') && preg_match('#^/admin/app/package_update/check/newest/code/(?P<code>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_package_update_check_newest')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AppPackageUpdateController::checkNewestAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/category')) {
                ...
                if (preg_match('#^/admin/category/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_category_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CategoryController::editAction',  '_permission' =>   array (    0 => 'admin_course_category_manage',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/category/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_category_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CategoryController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if ($pathinfo === '/admin/category/uploadfile') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\Admin\\CategoryController::uploadFileAction',  '_route' => 'admin_category_upload',  '_permission' =>   array (    0 => 'admin_course_category_manage',  ),  '_h5' => false,);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/login_record')) {
                ...
                if (preg_match('#^/admin/login_record/(?P<id>[^/]++)/details$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_login_record_details')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\LoginRecordController::showUserLoginRecordAction',  '_permission' =>   array (    0 => 'admin_login_record',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/thread')) {
                ...
                if (preg_match('#^/admin/thread/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_thread_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseThreadController::deleteAction',  '_permission' =>   array (    0 => 'admin_course_thread',    1 => 'admin_course_question_manage',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/question') && preg_match('#^/admin/question/(?P<postStatus>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_question')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseQuestionController::indexAction',  '_permission' =>   array (    0 => 'admin_course_question_manage',  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/a')) {
                if (0 === strpos($pathinfo, '/admin/approvals')) {
                    ...
                    if (preg_match('#^/admin/approvals/(?P<approvalStatus>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_approval_approvals')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserApprovalController::approvalsAction',  '_permission' =>   array (    0 => 'admin_approval_approvals',  ),  '_h5' => false,));
                    }

                    // admin_approval_approve
                    if (preg_match('#^/admin/approvals/(?P<id>[^/]++)/approve$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_approval_approve')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserApprovalController::approveAction',  '_permission' =>   array (    0 => 'admin_approval_approvals',  ),  '_h5' => false,));
                    }

                    // admin_approval_info_view
                    if (preg_match('#^/admin/approvals/(?P<id>[^/]++)/view$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_approval_info_view')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserApprovalController::viewApprovalInfoAction',  '_permission' =>   array (    0 => 'admin_approval_approvals',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/approvals/(?P<id>[^/]++)/cancel$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_approval_cancel')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserApprovalController::cancelAction',  '_permission' =>   array (    0 => 'admin_approval_cancel',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/approvals/idcard/show') && preg_match('#^/admin/approvals/idcard/show/(?P<userId>[^/]++)/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'show_idcard')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserApprovalController::showIdcardAction',  '_permission' =>   array (    0 => 'admin_approval_approvals',  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/article/category')) {
                    ...
                    if (preg_match('#^/admin/article/category/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_category_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleCategoryController::editAction',  '_permission' =>   array (    0 => 'admin_operation_article_category',  ),  '_h5' => false,));
                    }
                    ...
                    if (preg_match('#^/admin/article/category/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_category_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleCategoryController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/article')) {
                ...
                if (0 === strpos($pathinfo, '/admin/article/s')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/article/set/property') && preg_match('#^/admin/article/set/property/(?P<id>[^/]++)/(?P<property>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_set_property')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::setArticlePropertyAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/article/cancel/property') && preg_match('#^/admin/article/cancel/property/(?P<id>[^/]++)/(?P<property>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_cancel_property')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::cancelArticlePropertyAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                }

                // admin_article_edit
                if (preg_match('#^/admin/article/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::editAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/article/(?P<id>[^/]++)/publish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_publish')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::publishAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/article/(?P<id>[^/]++)/unpublish$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_unpublish')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::unpublishAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/article/thumb') && preg_match('#^/admin/article/thumb/(?P<id>[^/]++)/remove$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_thumb_remove')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::thumbRemoveAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/article/(?P<id>[^/]++)/trash$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_article_trash')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ArticleController::trashAction',  '_permission' =>   array (    0 => 'admin_operation_article_manage',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/invite')) {
                ...
                // admin_invite_record
                if ($pathinfo === '/admin/invite/record') {
            ...
            if (0 === strpos($pathinfo, '/admin/invite')) {
                ...
                if (preg_match('#^/admin/invite/(?P<filter>[^/]++)/coupon/?$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_invite_coupon')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\InviteController::couponAction',  'filter' => 'invited',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/group')) {
                ...
                if (preg_match('#^/admin/group/(?P<id>[^/]++)/close$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_close')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::closeGroupAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                }

                // admin_group_open
                if (preg_match('#^/admin/group/(?P<id>[^/]++)/open$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_open')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::openGroupAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/group/t')) {
                    if (0 === strpos($pathinfo, '/admin/group/thread')) {
                        ...
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/removeElite$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_cancel_elite')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::removeEliteAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }

                        // admin_group_thread_set_elite
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/setElite$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_set_elite')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::setEliteAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }

                        // admin_group_thread_cancel_stick
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/removeStick$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_cancel_stick')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::removeStickAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }

                        // admin_group_thread_set_stick
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/setStick$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_set_stick')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::setStickAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }

                        // admin_group_thread_close
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/closeThread$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_close')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::closeThreadAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }

                        // admin_group_thread_open
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/openThread$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_open')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::openThreadAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }
                        ...
                        if (preg_match('#^/admin/group/thread/(?P<threadId>[^/]++)/deleteThread$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_thread_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::deleteThreadAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                        }
                    ...
                    if (0 === strpos($pathinfo, '/admin/group/transfer') && preg_match('#^/admin/group/transfer/(?P<groupId>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_group_transfer')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\GroupController::transferGroupAction',  '_permission' =>   array (    0 => 'admin_operation_group_manage',  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/operation/analysis')) {
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/register') && preg_match('#^/admin/operation/analysis/register/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_register')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::registerAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/login') && preg_match('#^/admin/operation/analysis/login/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_login')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::loginAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/course_set') && preg_match('#^/admin/operation/analysis/course_set/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_course_set')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::courseSetAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/task') && preg_match('#^/admin/operation/analysis/task/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_task')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::taskAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/lesson/join') && preg_match('#^/admin/operation/analysis/lesson/join/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_lesson_join')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::joinLessonAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/course/paid') && preg_match('#^/admin/operation/analysis/course/paid/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_course_paid')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::paidCourseAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/task/completed') && preg_match('#^/admin/operation/analysis/task/completed/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_task_completed')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::completedTaskAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/classroom/paid') && preg_match('#^/admin/operation/analysis/classroom/paid/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_classroom_paid')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::paidClassroomAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/video')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/video/viewed') && preg_match('#^/admin/operation/analysis/video/viewed/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_video_viewed')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::videoViewedAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/video/cloud/viewed') && preg_match('#^/admin/operation/analysis/video/cloud/viewed/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_video_cloud_viewed')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::cloudVideoViewedAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/video/local/viewed') && preg_match('#^/admin/operation/analysis/video/local/viewed/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_video_local_viewed')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::localVideoViewedAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/video/net/viewed') && preg_match('#^/admin/operation/analysis/video/net/viewed/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_video_net_viewed')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::netVideoViewedAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/income') && preg_match('#^/admin/operation/analysis/income/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_income')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::incomeAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/c')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/course_set/income') && preg_match('#^/admin/operation/analysis/course_set/income/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_course_set_income')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::courseSetIncomeAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/classroom/income') && preg_match('#^/admin/operation/analysis/classroom/income/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_classroom_income')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::classroomIncomeAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/vip/income') && preg_match('#^/admin/operation/analysis/vip/income/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_vip_income')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::vipIncomeAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/course')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/course_set/sum') && preg_match('#^/admin/operation/analysis/course_set/sum/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_course_set_sum')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::courseSetSumAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/admin/operation/analysis/course/sum') && preg_match('#^/admin/operation/analysis/course/sum/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_course_sum')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::courseSumAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/user/sum') && preg_match('#^/admin/operation/analysis/user/sum/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_user_sum')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::userSumAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/route_analysis_data_type') && preg_match('#^/admin/operation/analysis/route_analysis_data_type/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_rount')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::routeAnalysisDataTypeAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/operation/analysis/lesson/exit') && preg_match('#^/admin/operation/analysis/lesson/exit/(?P<tab>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_operation_analysis_lesson_exit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnalysisController::exitLessonAction',  '_permission' =>   array (    0 => 'admin_operation_analysis',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/user_fields')) {
                ...
                if (0 === strpos($pathinfo, '/admin/user_fields/edit') && preg_match('#^/admin/user_fields/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_fields_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserSettingController::editUserFieldsAction',  '_permission' =>   array (    0 => 'admin_setting_user_fields',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/user_fields/delete') && preg_match('#^/admin/user_fields/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_fields_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserSettingController::deleteUserFieldsAction',  '_permission' =>   array (    0 => 'admin_setting_user_fields',  ),  '_h5' => false,));
                }
            ...
            if ($pathinfo === '/admin/order/manage/export') {
            ...
            if (0 === strpos($pathinfo, '/admin/co')) {
                ...
                if (0 === strpos($pathinfo, '/admin/common')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/common/remove') && preg_match('#^/admin/common/remove/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_common_remove')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CommonAdminController::commonRemoveAction',  '_permission' =>   array (    0 => 'admin',  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/announcement')) {
                ...
                if (0 === strpos($pathinfo, '/admin/announcement/delete') && preg_match('#^/admin/announcement/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_announcement_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnnouncementController::deleteAction',  '_permission' =>   array (    0 => 'admin_announcement',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/announcement/edit') && preg_match('#^/admin/announcement/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_announcement_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\AnnouncementController::editAction',  '_permission' =>   array (    0 => 'admin_announcement',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/batch_notification')) {
                ...
                if (0 === strpos($pathinfo, '/admin/batch_notification/edit') && preg_match('#^/admin/batch_notification/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_batch_notification_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BatchNotificationController::editAction',  '_permission' =>   array (    0 => 'admin_batch_notification',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/batch_notification/delete') && preg_match('#^/admin/batch_notification/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_batch_notification_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BatchNotificationController::deleteAction',  '_permission' =>   array (    0 => 'admin_batch_notification',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/batch_notification/send') && preg_match('#^/admin/batch_notification/send/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_batch_notification_send')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BatchNotificationController::sendAction',  '_permission' =>   array (    0 => 'admin_batch_notification',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/cloud')) {
                ...
                if (0 === strpos($pathinfo, '/admin/cloud/edulive')) {
                    ...
                    if ($pathinfo === '/admin/cloud/edulive/upload') {
                        ...
                        return array (  '_controller' => 'AppBundle\\Controller\\Admin\\EduCloudController::uploadLiveLogoAction',  '_route' => 'admin_cloud_upload_live_logo',  '_permission' =>   array (  ),  '_h5' => false,);
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/cloud/edulive') && preg_match('#^/admin/cloud/edulive/(?P<type>[^/]++)/logo/crop$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_cloud_edulive_logo_crop')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\EduCloudController::logoCropAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/keyword')) {
                ...
                if (preg_match('#^/admin/keyword/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_keyword_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SensitiveController::deleteAction',  '_permission' =>   array (    0 => 'admin_keyword',  ),  '_h5' => false,));
                }
                not_admin_keyword_delete:

                // admin_keyword_change
                if (preg_match('#^/admin/keyword/(?P<id>[^/]++)/change$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_keyword_change')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SensitiveController::changeAction',  '_permission' =>   array (    0 => 'admin_keyword',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/classroom')) {
                ...
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/close$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_close')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::closeClassroomAction',  '_permission' =>   array (    0 => 'admin_classroom_close',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/open$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_open')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::openClassroomAction',  '_permission' =>   array (    0 => 'admin_classroom_open',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::deleteClassroomAction',  '_permission' =>   array (    0 => 'admin_classroom_delete',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/classroom/thread')) {
                    ...
                    if (preg_match('#^/admin/classroom/thread/(?P<threadId>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_thread_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomThreadAdminController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
                ...
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/recommend$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_set_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::recommendAction',  '_permission' =>   array (    0 => 'admin_classroom_manage',  ),  '_h5' => false,));
                }

                // admin_classroom_cancel_recommend
                if (preg_match('#^/admin/classroom/(?P<id>[^/]++)/recommend/cancel$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_cancel_recommend')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomAdminController::cancelRecommendAction',  '_permission' =>   array (    0 => 'admin_classroom_manage',  ),  '_h5' => false,));
                }
                ...
                if (0 === strpos($pathinfo, '/admin/classroom/re')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/classroom/review')) {
                        ...
                        if (preg_match('#^/admin/classroom/review/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_classroom_review_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\ClassroomReviewController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                        }
            ...
            if (0 === strpos($pathinfo, '/admin/org')) {
                ...
                if (preg_match('#^/admin/org/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_org_update')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrgManageController::updateAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/org/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_org_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrgManageController::deleteAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/batch/update') && preg_match('#^/admin/batch/update/(?P<module>[^/]++)/org$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_batch_update_org')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\OrgManageController::batchUpdateAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/role')) {
                ...
                if (preg_match('#^/admin/role/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_role_edit')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\RoleController::editAction',  '_permission' =>   array (    0 => 'admin_role_edit',  ),  '_h5' => false,));
                }
                ...
                if (preg_match('#^/admin/role/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_role_delete')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\RoleController::deleteAction',  '_permission' =>   array (    0 => 'admin_role_delete',  ),  '_h5' => false,));
                }
                not_admin_role_delete:

                // admin_role_show
                if (preg_match('#^/admin/role/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_role_show')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\RoleController::showAction',  '_permission' =>   array (    0 => 'admin_role_manage',  ),  '_h5' => false,));
                }
            ...
            if (0 === strpos($pathinfo, '/admin/login')) {
                ...
                if ($pathinfo === '/admin/login/marketing') {
                ...
                if ($pathinfo === '/admin/login/distributor') {
            ...
            if (0 === strpos($pathinfo, '/admin/crontab')) {
                // admin_crontab
                if ($pathinfo === '/admin/crontab') {
                ...
                if ($pathinfo === '/admin/crontab/restore') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
            ...
            if (0 === strpos($pathinfo, '/admin/job')) {
                // admin_job_enabled
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/enabled$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_job_enabled;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_enabled')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::enabledAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_admin_job_enabled:

                // admin_job_disabled
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/disabled$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_job_disabled;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_disabled')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::disabledAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }
                not_admin_job_disabled:

                // admin_job_fires
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/fires$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_fires')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::firesAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_job_fired_logs
                if (preg_match('#^/admin/job/(?P<id>[^/]++)/fire/(?P<jobFiredId>[^/]++)/logs$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_job_fired_logs')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\JobController::fireLogsAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

            }

            if (0 === strpos($pathinfo, '/admin/xapi/s')) {
                // admin_xapi_setting
                if ($pathinfo === '/admin/xapi/setting') {
                ...
                if (0 === strpos($pathinfo, '/admin/xapi/statement')) {
                    ...
                    if ($pathinfo === '/admin/xapi/statement_list') {
                    ...
                    if (preg_match('#^/admin/xapi/statement/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_xapi_statement_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\XapiController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/c')) {
                if (0 === strpos($pathinfo, '/admin/course')) {
                    ...
                    if (preg_match('#^/admin/course/(?P<courseId>[^/]++)/datas/export/prepare$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_task_data_export_prepare')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseController::prepareForExportTasksDatasAction',  '_permission' =>   array (    0 => 'admin_course_set_data',  ),  '_h5' => false,));
                    }

                    // admin_course_task_data_export
                    if (preg_match('#^/admin/course/(?P<courseId>[^/]++)/datas/export$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_task_data_export')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseController::exportTaskDatasAction',  '_permission' =>   array (  ),  '_h5' => false,));
                    }
            ...
            // sms_prepare
            if (0 === strpos($pathinfo, '/admin/sms/prepare') && preg_match('#^/admin/sms/prepare/(?P<targetType>[^/]++)/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sms_prepare')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SmsController::prepareAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // publish_sms_send
            if (0 === strpos($pathinfo, '/admin/publish/sms_send') && preg_match('#^/admin/publish/sms_send/(?P<targetType>[^/]++)/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'publish_sms_send')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\SmsController::sendAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            // generate_short_link
            if ($pathinfo === '/admin/generate/short/link') {
            ...
            if (0 === strpos($pathinfo, '/admin/queue/failed_log')) {
                // admin_queue_failed_logs
                if ($pathinfo === '/admin/queue/failed_logs') {
                ...
                if (preg_match('#^/admin/queue/failed_log/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_queue_failed_log_modal')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\QueueController::failedJobAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

            }

            // admin_online
            if ($pathinfo === '/admin/online') {
            ...
            // admin_bill
            if (0 === strpos($pathinfo, '/admin/bill') && preg_match('#^/admin/bill/(?P<type>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_bill')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BillController::billAction',  '_permission' =>   array (  ),  '_h5' => false,));
            }

            if (0 === strpos($pathinfo, '/admin/user/learn')) {
                // admin_user_learn_statistics
                if ($pathinfo === '/admin/user/learn/statistics') {
                ...
                if (preg_match('#^/admin/user/learn/(?P<userId>[^/]++)/detail$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_learn_detail')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserLearnStatisticsController::detailAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_user_learn_chart
                if (preg_match('#^/admin/user/learn/(?P<userId>[^/]++)/chart$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_learn_chart')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\UserLearnStatisticsController::learnChartAction',  '_permission' =>   array (  ),  '_h5' => false,));
                }

                // admin_user_learn_statistics_info
                if ($pathinfo === '/admin/user/learn/statistics/info') {
            ...
            if (0 === strpos($pathinfo, '/admin/f')) {
                ...
                if ($pathinfo === '/admin/face_identify/setting') {
            ...
            if (0 === strpos($pathinfo, '/admin/data/lab/setting')) {
                ...
                if ($pathinfo === '/admin/data/lab/setting') {
                ...
                if (0 === strpos($pathinfo, '/admin/data/lab/setting/modal')) {
                    // admin_cloud_data_lab_setting_enable_modal
                    if ($pathinfo === '/admin/data/lab/setting/modal/enable') {
                    ...
                    if ($pathinfo === '/admin/data/lab/setting/modal/disable') {
            ...
            if (0 === strpos($pathinfo, '/admin/c')) {
                ...
                if ($pathinfo === '/admin/cloud/accessWechat') {
                ...
                if ($pathinfo === '/admin/course_set/tag/match') {
