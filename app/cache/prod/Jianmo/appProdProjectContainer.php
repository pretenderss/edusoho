...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['activity_config_manager'] = new \AppBundle\Component\Activity\ActivityConfigManager(__DIR__, ($this->targetDirs[3].'/../web/activities'), false);
    }
    ...
    {
        return $this->services['codeages_plugin.dict_collector'] = new \Codeages\PluginBundle\System\DictCollector(array(0 => ($this->targetDirs[4].'\\src\\AppBundle\\Resources\\config\\dict.en.yml'), 1 => ($this->targetDirs[4].'\\src\\AppBundle\\Resources\\config\\dict.zh_CN.yml')), __DIR__, false, 'zh_CN');
    }
    ...
    {
        $this->services['monolog.handler.nested'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[3].'\\logs/prod.log'), 100, true, NULL);
