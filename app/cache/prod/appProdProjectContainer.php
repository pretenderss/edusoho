...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['activity_config_manager'] = new \AppBundle\Component\Activity\ActivityConfigManager(__DIR__, ($this->targetDirs[2].'/../web/activities'), false);
    }
    ...
    {
        return $this->services['api_firewall'] = new \ApiBundle\Security\Firewall\Firewall(array(0 => $this->get('api_basic_authentication_listener'), 1 => $this->get('api_token_header_listener'), 2 => $this->get('api_old_token_header_listener'), 3 => $this->get('api_third_party_oauth2_authentication_listener'), 4 => $this->get('api_session_authentication_listener'), 5 => $this->get('api_web_lib_listener'), 6 => $this->get('api_anonymous_listener')));
    }
    ...
    {
        return $this->services['assets._version__default'] = new \AppBundle\Twig\Asset\VersionStrategy\StaticVersionStrategy('8.3.20', '%s?version=%s', $this->get('biz'));
    }
    ...
    protected function getBazinga_Jstranslation_ControllerService()
    {
        ...
        $this->services['bazinga.jstranslation.controller'] = $instance = new \Bazinga\Bundle\JsTranslationBundle\Controller\Controller($this->get('translator.default'), $this->get('templating'), $this->get('bazinga.jstranslation.translation_finder'), (__DIR__.'/bazinga-js-translation'), false, 'zh_CN', 'js', '86400');
    ...
    {
        return $this->services['codeages_plugin.dict_collector'] = new \Codeages\PluginBundle\System\DictCollector(array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Resources\\config\\dict.en.yml'), 1 => ($this->targetDirs[3].'\\src\\AppBundle\\Resources\\config\\dict.zh_CN.yml')), __DIR__, false, 'zh_CN');
    }
    ...
    {
        return $this->services['doctrine.orm.entity_manager'] = \Doctrine\ORM\EntityManager::create(array('driver' => 'pdo_mysql', 'user' => 'root', 'password' => '', 'dbname' => 'edusoho', 'host' => '127.0.0.1', 'port' => 3306), $this->get('doctrine.entity_manager.config'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $aa = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'jstzke9iqpcogo0w08gckckk4ogcsw0', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('jstzke9iqpcogo0w08gckckk4ogcsw0');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'zh_CN',
            'secret' => 'jstzke9iqpcogo0w08gckckk4ogcsw0',
            'webpack_base_url' => 'http://localhost',
            'user_partner' => 'none',
            'doctrine.config_paths' => array(
                'D:\\workspace\\vboxShare\\edusoho\\app/../vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle/Resources/config/doctrine' => 'OAuth2\\ServerBundle\\Entity',
            ),
            ...
            'kernel.secret' => 'jstzke9iqpcogo0w08gckckk4ogcsw0',
